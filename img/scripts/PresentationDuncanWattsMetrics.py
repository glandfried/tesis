...
def plot_all_plots(previously_calculated_values, plots, color, label):
    (fractionSizesPlot, meanShortestPathsPlot) = plots
...
def main():
    ...
    fig, plots = plt.subplots(2, sharex='all')
    ...
    plt.savefig(dir_name + '/presentation-duncan-watts-metrics.pdf', bbox_inches="tight", pad_inches=0)
