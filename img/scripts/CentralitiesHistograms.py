...
def plot_centralities_hist(centralities_dict):
    ...
    for centrality in CENTRALITY_NAMES.keys():
        ...
        plt.hist(cent_means, bins=transformed_bins, color=CB91_Blue, rwidth=0.8, alpha=0.9)
        for percentile in centrality_groups[centrality][:-1]:
            plt.axvline(percentile, color=CB91_Purple, linestyle='--', linewidth=1)

        dir_name = 'resultados/centralidades'
