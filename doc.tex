...
\section{El concepto de verdad durante la colonial-modernidad}

Desde Hegel hasta la fecha, las explicaciones eurocéntricas intentan explicar la proposperidad actual de occidente a través de una causa interna: el ``espíritu protestante'' de Weber, la ``mentalidad burguesa'' de Romero, o más recientemente el ``sistema de parentezco'' de Henrich.
...
La coincidencia de un conjunto de eventos produjo un giro radical en la historia de la huamidad cuando esta sociedad históricamente marginal, sumida en la violencia interna, quedó de repente en una situación de privilegio mundial.
...
En América del sur el estado incaico que estaba organizado en base a un sistema de intercamios no monetarios en una región montañosa rica en plata.
...
\begin{framed}
Todos los conocimientos que la sociedad colonial-moderna va incorporando del resto de comunidades del mundo se les borra su verdadero origen histórico y se las enaltecen como surgimientos espontaneos internos.
...
A pesar de todos los avances científicos, la ciencia metropolitana no fue capaz de compensar la pérdida de los conocimientos milenarios acumulados por las comunidades autónomas locales.
\end{framed}
...
El derecho a las autonomías comunitarias se sustenta en el hecho práctico de que el único conocimiento cultural ecológicamente adaptado evoluciona sólo a través de la experiencia que acumulan los pueblos en el transcurso de su historia~\cite{segato2013-colonialidad}.
...
Los estudios comparados indican que las únicas instituciones capaces de administrar a largo plazo los bienes comunes, nunca fueron ni estatales ni privadas, son de tipo comunitarias histórico arraigo local~\cite{ostrom2010,ostrom1990}.
