...
%
Si bien la deserción puede tener un ventaja a corto plazo (\emph{propiedad mayor}), a largo plazo los variantes desertoras ven afectada negativamente su propia tasa de crecimiento debido a que su propio comportamiento aumentan las fluctuaciones de los cooperadores de quienes dependen, aumentando al mismo tiempo sus propias fluctuaciones (\emph{propiedad mayor}). 
...
En la breve historia del ser humano, la experiencia acumulada por comunidades alrededor del mundo también condujo, de forma independiente, a una obligación universal de dar y de recibir~\cite{mauss1923-leDon}.
%
...
Los estudios comparados muestran que las instituciones humanas capaces de administrar exitosamente los bienes comunes se emergen por fuera tanto de las instituciones públicas como privadas, especialmente en comunidades autónomas con fuerte arraigo local que alcanzaron establecer relaciones de largo plazo con sus sistemas ecológicos.
%
Se han detectado una serie de características comunes a todas estas instituciones tales como que: la mayoría de los individuos involucrados en el sistema ecológico están autorizados a participar en la elaboración y modificación de sus normas; la supervisión de los comportamientos está a cargo de sus miembros; las sanciones son graduales y bajas.

% Parrafo

El remplazo repentino de estos sistemas culturales locales por instituciones externas, tanto privadas como públicas, que exhiben lógicas ``singulares y definitvas'' ha producido devastadoras consecuencias ecológicas~\cite{segato2013-colonialidad, ostrom2010}.
%
...
Los pueblos que administran los exitosamente los bienes comunes exhiben lógicas ``plurales y condicionales'' que fomentan la convivencia con otras formas de vida, otros pueblos y otros conocimientos~\cite{segato2018-manifesto}.
%
Uno de los elementos claves que garantiza su supervivencia en el tiempo es el desarrollo de tecnologías de reciprocidad que tienen la función de re-activar los vínculos comunitarios mediante ritos (festivos o coercitivos) de intercambios~\cite{zaffaroni2013-cuestionCriminal, segato2016-guerraContraLasMujeres}.
%
El elemento indispensable es la autonomía comunitaria, el reconocimiento de las comunidades vecinas a establecer sus propias normas, y las relaciones intercomunitarias de coexistencia.
%
