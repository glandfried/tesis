...
\end{equation*}
%
Los valores $x_i \in (-\infty, \infty)$ no son hip\'otesis sino constantes que conocemos con exactitud al momento de recibir la observaci\'on de la hip\'otesis $Y_i$.
%
Las hip\'otesis de investigaci\'on (o experimento) $\mathcal{H}$ de un modelo causal lineal son de $Y_0$ a $Y_N$ y de $W_0$ a $W_D$, con $Y_0=\dots=Y_N=W_0=\dots = W_D = (-\infty, \infty)$, el conjunto de los números reales.
%
