...
Descargamos 16500 papers.
%
Su distribución tiene un crecimiento exponencial.
%
\begin{figure}[ht!]
\centering
...
Seguramente existen artículos previos que no fueron identificados.
%
En todo caso, no se registra un crecimiento exponencial previo al año 1990, cuando comienza el período de masificación de las computadoras personales.
%
...
%
En el año 1998, al mismo tiempo que la Internet comienza a hacerse popular, se produce un aumento de 66\% en la cantidad de publicaciones respecto del año anterior y el inicio de la segunda etapa de crecimiento exponencial del enfoque bayesiano, que perdura hasta el año 2012.
%
En este período la inferencia bayesiana estaba en el centro de los aplicaciones de última generación de la inteligencia artificial, hasta que en el año 2012 se produce el inicio de la revolución de las redes neuronales.

% Parrafo

ImageNet es una base de datos en línea con millones de imágenes etiquetadas a mano. El concurso anual ImageNet anima a los profesionales del sector a competir y medir sus progresos para conseguir que los ordenadores reconozcan y etiqueten imágenes automáticamente. En un taller de seguimiento, los ganadores comparten y debaten sus técnicas. En 2010, el sistema ganador pudo etiquetar correctamente una imagen el 72\% de las veces (para los humanos, la media es del 95\%). En 2012, un equipo dirigido por Geoff Hinton, de la Universidad de Toronto, logró un aumento de la precisión hasta el 85\%, gracias a una novedosa técnica conocida como "aprendizaje profundo". Esto trajo consigo mejoras aún más rápidas, produciendo una precisión del 96\% en el Desafío ImageNet en 2015 y superando a los humanos por primera vez.


desde entonces el crecimiento exponencial en la cantidad de artículos publicados nos llevó a los 1611 artículos del año 2021 (último año con registros completos).
...
contactar personalmente a la mitad de los investigadores de la comunidad.
...
Al haber verificado la debilidad de la comunidad bayesiana en Argentina, al final del doctorado comencé a impulsar, junto con algunos de sus protagonistas, el primer Congreso Bayesiano Plurinacional.
%
...
\centering
  ...
  \end{subfigure}
  \caption{Congreso Bayesiano Plurinacional, agosto 2023 en el Nodo Tecnológico de Santiago del Estero}
\end{figure}
...
\hspace{0.6cm} 4. \textbf{Yasmín Elena Navarrete Díaz}: Sistemas frágiles: una formulación bayesiana de la teoría cuántica.

\hspace{0.6cm} 5. \textbf{Diego Javier Ramón Sevilla}: Regresión bayesiana para el análisis de series temporales con apilamiento en Astronomía de rayos X.

\hspace{0.6cm} 6. \textbf{Andrea Paula Goijman}: Modelos de ocupación multiespecie con enfoque bayesiano: una herramienta valiosa para estudios de biodiversidad en ecología

\hspace{0.6cm} 7. \textbf{Hossein Dinani}: Bayesian estimation for quantum sensing.

\hspace{0.6cm} 8. \textbf{Albert Ortiz}: Aplicación de métodos bayesianos en ingeniería estructural.

\hspace{0.6cm} 9. \textbf{Gonzalo Ríos}: Bayesian Machine Learning Applied to Marketing.

\hspace{0.6cm} 10. \textbf{Sergio Michael Davis Irarrázabal}: Probabilidad bayesiana a partir de la estimación plausible de cantidades.

\hspace{0.6cm} 11. \textbf{Tomás Olego}: Métodos robustos Bayesianos Generalizados para los modelos de regresión logística.

\hspace{0.6cm} 12. \textbf{Luciano Moffatt}. Modelado Bayesiano  Computacional de Sistemas Biológicos.
