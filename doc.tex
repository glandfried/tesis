...
%
La aplicación estricta de las reglas de la probabilidad (o enfoque bayesiano) responde con claridad cómo se construyen las verdades en ciencias empíricas, o cómo no mentir en contextos de incertidumbre.
%
Si embargo, la inteligencia no se reduce a la verdad, pues no todas las verdades son igualmente relevantes.
%
De esta forma, el inteligencia requiere al menos una dimensión adicional a la de probabilidad (o creencia) que permita describir y actualizar la graduación de relevancias en función del contexto.
%
En este sentido, la palabra ``inteligencia'' es una buena elección en términos etimológicos pues proviene del latín \emph{intelligentia} que significa la cualidad (sufijo -\emph{ia}) del quien (sufijo -\emph{nt}-) saber leer o escoger (verbo \emph{legere}) entre varias opciones (prefijo \emph{inter}).
...
%
Por el contrario, las proyecciones del crecimiento poblacional indican que estamos en las vísperas del estancamiento, con un tamaño 30\% superior al actual.
%
Lo cierto es que este límite a la biomasa humana no está impuesto por la capacidad de la tierra, sino por nuestra incapacidad actual para integrarnos de forma orgánica en los sistemas ecológicos existentes.
...
%
Los procesos de selección de las formas de vida, por secuencias de tasas de reproducción y supervivencia, es como el proceso de evaluación de las hipótesis en probabilidad, por secuencia de predicciones, de naturaleza multiplicativa.
%
Un único cero en la secuencia produce una extinción irreversible.
%
Por ello, las variantes que emergen en probabilidad y evolución son las hipótesis o formas de vida que evitan el peor caso, reduciendo fluctuaciones por diversificación individual o por especialización heterogénea cooperativa.

% Parrafo

La sociedades humanas que han mostrado la capacidad
%
