...
Cuando hacemos referencia a modelos causales nos estamos refiriendo a modelos que se resuelven aplicando las reglas de la probabilidad y que cumplen con la definici\'on probabil\'istica de causalidad~\cite{winn2012-causality}.
%
...
%
De todos los sistemas axiom\'atico, el de Kolmogorov es el m\'as utilizado.

% Parrafo

En la sección \ref{} presentamos los axiomas de Kolmogorov, en su versión simple.
%
En la sección \ref{} discutimos el costo computacional de la aplicación estricta de las reglas de la probabilidad y revisamos la evaluación de modelos.
%
En la sección \ref{} presentemos el modelo de estimación de habilidad utilizado a lo largo de la tesis.
...
%
Cuando le asignamos una probabilidad arbitraria a cada hipótesis elemental $\{p_1, p_2, \dots p_k\}$ tal que la suma $p_1 + p_2 + p_3 = 1$, tenemos definido un campo de probabilidades.
...
\section{El costo computacional de las reglas de la probabilidad}
...
\subsection{Evaluación de modelos bajo las reglas de la probabilidad}
