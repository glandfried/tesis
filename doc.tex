...
%
En la figura \ref{fig:balance_natural} se grafica la predicci\'on a priori de $P(y_N|x_N=0.1, M_D)$ que hace un modelo rígido $D=1$, un modelo simple $D=3$, y un modelo compelejo $D=9$.
%
