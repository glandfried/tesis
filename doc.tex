...
Tan importantes como las tecnologías de reciprocidad social son las tecnologías de recioprocidad ecológica con las otras especies.
%
Los estudios comparados indican que las instituciones capaces de interactuar de forma estable con los sistemas ecológicos son de tipo comunitarias basados en normas consuetudinarias que evolucionaron como acumulación de conocimiento experto local a través de experiencia inter-generacional de sus miembrtos~\cite{ostrom1990}.
% 
El remplazo de estos sistemas culturales expertos locales por instituciones modernas externas, privadas o públicas, produce generalmente desequilibrios en los sistemas ecológicos que reducen el tamaño máximo de población humana que el ambiente puede soportar~\cite{ostrom2010}.
%
De forma similar a las tecnologías de reciprocidad social, las tecnologías de reciprocidad ecológica reducen las fluctuaciones de las especies de las cuales dependemos que podrían poner en peligro la supervivencia de la comunidad.

% Parrafo

Las tecnologías de reciprocidad ecológica produjeron la aparición independiente de la domesticación de especies animales y vegetales, el desarrollo de caracteres genéticos especiales que surgen como el resultado de una interacción prolongada entre las especies.
%
En particular, la reciprocidad con las especies fotosintéticas (agricultura), únicas con la capacidad de producir materia orgánica a partir del sol y la materia inorgánica, produjo nuevamente cambios radicales para nuestra especie.
%
...
%
La agricultura produjo un aumento poblacional.
%
...
Además, los pueblos bien adaptados para la coexistencia intercultural y ecológica practican cosmovisiones basadas en lógicas paraconsistentes que les permite creer en A y no A al mismo tiempo, pues la preferencia de una opción no se traduce en el rechazo de su complemento.
...
% Tecnologías de reciprocidad. 
% Evolución de instituciones que reducen las fluctuaciones socio-ecol ́ógicas
% 
% 
% 
% El cambio climático ocurrido al inicio del Holoceno (hace 12000 años) propició el desarrollo de la agricultura, un 
% 
