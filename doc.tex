...
%Hace 3500M años surgió en la tierra una organización de la materia capaz de autoreplicarse.
La evolución es un sistema de procesamiento distribuido de información.
%
Desde su origen, el crecimiento de oss linajes siguieron procesos multiplicativos y ruidosos: secuencias de tasas de supervivencia y reproducción.
%
...
%
La vida adquirió así una extraordinaria complejidad a nivel de cooperación como de especialización.
%
...
%
La aparición de la crianza cooperativa, sin embargo, favoreció la selección de jóvenes más capaces para la comprensión mutua, la imitación y el aprendizaje social.
%
Los conocimiento adquiridos por experiencia individual comenzaron a ser transmitido a la siguiente generación.
%
...
Si bien la inferencia bayesiana y la evolución cultural son modelo ideal de la cognición y la transmición de información en el tiempo, varias preguntas acerca de cómo aprender las personas en contextos reales sigue abierta.
%
Poner a prueba estas hipótesis se ha visto obstaculizado debido a que para ello se requieren datos granulares y longitudinales del comportamiento de todos los individuos de una comunidad humana en el tiempo.
%
Por ese motivo decidimos aprovechar el repositorio prácticamente infinito de comportamiento humano disponible en Internet para estudiar estudiar en detalle algunas de sus comunidades virtuales.

% Parrafo

Para estudiar el aprendizaje fue necesario realizar la primera implementación del estimador de habilidad estado-del-arte en la industria del video juego en los lenguajes de progrmación Julia, Python y R.
%
A diferencia de los estimadores de habilidad más utilizados en la industria del video juego (como Elo, Glicko y TrueSkill), el modelo TrueSkill Through Time (TTT) propaga toda la información histórica en una única red bayesiana, lo que permite realizar estimaciones fiables de la habilidad inicial y garantizar la comparabilidad histórica. 

% Parrafo

Este modelo de nos permitió responder preguntas relativas al aprendizaje social.
%
Por ejemplo, debido a que la cultura es una fenómeno poblacional que emerge como consecuencia del intercambio de información entre individuos existía una hipótesis que afirmaba que la estructura y el tamaño de estas redes afectan directamente los procesos de acumulación cultural del que dependen los individuos para el aprendizaje social.
%
Por otra parte 
