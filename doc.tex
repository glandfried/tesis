...
%
Vista de esta forma, la palabra ``inteligencia'' es una buena elección en términos etimológicos pues proviene del latín \emph{intelligentia} que significa la cualidad (sufijo -\emph{ia}) del quien (sufijo -\emph{nt}-) sabe escoger (verbo \emph{legere}) entre varias opciones (prefijo \emph{inter}).
...
%
Los problemas de la física y la química existen en tanto se subsumen como relevantes para la vida.
%
...
%
El crecimiento exponencial de la población humana no se inicia en la modernidad, sino con el crecimiento exponencial de nuestra insólita capacidad de acumulación cultual.
%
De hecho, las proyecciones de la ONU indican que estamos a menos de un siglo del estancamiento poblacional, con un tamaño que sería 30\% superior al actual.
%
...
% Parrafo
%
% Los procesos de selección de las formas de vida, por secuencias de tasas de reproducción y supervivencia, son como el proceso de evaluación de las hipótesis en probabilidad, por secuencia de predicciones, de naturaleza multiplicativa.
% %
% Un único cero en la secuencia produce una extinción irreversible.
% %
% Por ello, las variantes que emergen en probabilidad y evolución son las hipótesis o formas de vida que evitan el peor caso mediante diversificación individual o especialización heterogénea cooperativa (detalles en introducción).
% %


% Parrafo

% Este proceso de crecimiento exponencial de la
%
...
En el corto plazo siempre es más fácil destruir que construir.
%
Y si consideramos que la inteligencia es la capacidad de la vida de sobrevivir y reproducirse, su exterminio parece ser su antónimo más acabado: la ignorancia.
%
...
%
Un proceso similar en la historia de la humanidad ocurrió localmente en Europa occidental luego de la masiva erradicación de la diversidad cultural producida por el Imperio Romano en su entorno, y el posterior inicio de un largo proceso de involución cultural conocido como Edad Media.
%
Del mismo modo que seleccionar una única hipótesis tiene consecuencias negativas conocidas en probabilidad (overfitting), la imposición de un único tipo de sociedad ya ha mostrado tener consecuencia negativas.
%
% % Parrafo
%
% El derrumbe de una sociedad altamente tecnificada como la nuestra, en un contexto de escasa diversidad cultural y profundización de la crisis ecológica, no es en absoluto improbable.
%
% % Parrafo
%
%
...
\emph{Suma Manq'aña} (Saber comer): Comer es intercambio de vida. Somos lo que comemos.

\emph{Suma Umaña} (Saber beber). El agua es la fuente de toda forma de vida.

\emph{Suma Thokoña} (Saber danzar). Actuar siempre con una dimensión espiritual.

\emph{Suma Ikiña} (Saber dormir). Dormir antes de la media noche, para tener la energía de dos días.

\emph{Suma Irnakaña} (Saber trabajar). El trabajo comunitario es alegría.

\emph{Suma Lupiña} (Saber meditar). El silencio personal (\emph{Amiki}) restablece el silencio del entorno (\emph{Ch'uju}).

\emph{Suma Amuyaña} (Saber pensar). Sin perder la razón, caminemos la senda del corazón.

\emph{Suma Munaña Munayasiña} (Saber amar y ser amado). El proceso de complementariedad y respeto a todo lo que existe.

\emph{Suma Ist'aña} (Saber escuchar). Percibir, sentir, escuchar con todo el cuerpo.

\emph{Suma Aruskipaña} (Saber hablar). Antes de hablar hay que sentir y pensar bien. Lo que se habla se escribe en los corazones de quienes escuchan.

\emph{Suma Samkasiña} (Saber soñar). Todo empieza desde los sueños. Por eso, los sueños son el inicio de la realidad.

\emph{Suma Sarnaqaña} (Saber caminar). No existe el cansancio para quien sabe caminar. Nunca se camina solo, se camina junto a la Pachamama.

\emph{Suma Churaña, suma Katukaña} (Saber dar y saber recibir). Hay que dar y recibir con dicha y agradecimiento porque la vida es la unión de muchos seres y fuerzas.
