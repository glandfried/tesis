...
%
En la sección anterior hemos visto un principio intercultural que nos permite alcanzar un primer acuerdo intersubjetivo en estos contextos de incertidumbre.
%
Los enfoques de la teoría de la probabilidad que rechazan todo criterio para definir distribuciones de creencias iniciales, como el ``frecuentista'', se ven impedidos de utilizar el teorema de Bayes.
%
Como consecuencia de no poder ofrecer distribuciones de probabilidad sobre todo el espacio de hipótesis, el enfoque frecuentista selecciona una única hipótesis (estimación puntual) en base a funciones de costo ad-hoc, siendo las más común la maximización de la verosimilitud.

\subsubsection*{Verosimilitud}

La \emph{verosimilitud} es la predicción del dato cuando la hipótesis que estamos evaluando es cierta.
%
Veamos cuál es la verosimilitud, $P(s2|r_i, \text{Modelo A})$, la probabilidad de que la pista señale la caja $2$ en el modelo de Monty Hall dado que el regalo está en la caja $r_i$.
%
\begin{figure}[ht!]
