...
\tikz{            
    ...
    \node[const, below=of d] (pd) {$\text{Creencia}(s=i|r=i) = 0$} 
...
\end{figure}
%
Donde los círculos representan las variables y la felcha representa la relación causal.
%
...
%
Por último, la Creencia de Lo que aparece del lado derecho del operador \emph{condicional} ($\cdot \mid \cdot$) representa hipótesis que momentáneamente se ponen fuera de toda duda, se toman como si fueran una certeza.
%
\todo[inline]{SEGUIR acá}
%
Dado este modelo, existe un conjuto finito de universos paralelos posibles.
%
Primero se abren tres universos posibles por cada uno de las posiciones que puede adquirir el regalo.
%
Y luego, dada la posición del regalo, se abren dos uniersos posibles por cada una de las posiciones que puede adquirir la pista. 
%
...
%
Luego, la \textbf{creencia conjunta} honesta a priori de que el regalo se encuentre en la posición $1$ y la pista señale la caja $2$ es $1/6$.
%
\begin{equation}
