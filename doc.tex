...
\end{figure}
%
Estas ideas siguieron discutiéndose en la cuarta sesión de conversaciones, realizada al mediodía destinada a ``Ideas: comunidad y colaboración''.
%
Cuando llegamos finalmente a la asamblea de cierre ``Conclusiones: acciones a futuro'', muchas de las ideas ya habían sido tratadas.
%
Allí decidimos, además de darle continuidad al Congreso Bayesiano Plurinacional y los Seminarios Virtuales, la organización la Escuela Bayesiana Plurinacional y las Reuniones Virtuales Resolución de Problemas.

% Parrafo

Durante el congreso se manifestó una imperiosa necesidad de contar con instancias de formación teórica y práctica.
%
...
La cuarta sesión de conversaciones, en una zona verde luego del almuerzo.
%
Como actividad de cierre simplemente retomamos las ideas ya discutidas,
%
Aquí las transcribimos.



% Parrafos

y en la sesión de cierre nos reunimos
...
al inicio de cada día, luego del almuerzo de cada día, y como final del congreso



% Parrafo

Tuvimos 12 charlas en profundidad sobre la aplicación de métodos bayesianos a diversos problemas
