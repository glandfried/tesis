...
Lo singular de nuestra especie es esta capacidad de acumular adaptaciones culturales en el tiempo, modificaciones sucesivas que van produciendo el sistema de información cultural humano, inimaginablemente complejo.
%
Si bien el aprendizaje humano ocurre en nuestros cuerpos, es parte de un fen\'omeno poblacional que emerge como consecuencia del intercambio de informaci\'on entre individuos.
%
...
Comprender algunas de las relaciones que vínculan el nivel poblacional (como la dinámica y estructura de la red de intercambios de información cultural) con el nivel individual (el aprendizaje efectivo que se produce en nuestros cuerpos), ha sido la pregunta general que intentamos explorar en esta tesis.
%
...
%
Los modelos de estimación de habilidad que se utilizan para medir el desempeño de los individuos en la industria del video juego difiere del concepto de aprendizaje que esperaríamos encontrar desde un punto de vista biológico, cognitivo o social.
%
En pocas palabras, los modelos utilizados en la industria del video juego (al igual que gran parte de las evaluaciones internacionales de los sistemas educativos) son instrumentos que predicen la probabilidad de éxito o fracaso.
%
Ya veremos, en los capítulos 2 y 4, que el modelo causal sobre el que se basan las estimaciones es una simplificación extrema de la realidad causal que cualquiera de nosotros puede imaginar de un proceso real de aprendizaje humano.

% Parrafo

Cuando hablamos de modelos causales nos referimos a modelos que se resuelven aplicando las reglas de la probabilidad y que cumplen con la definición probabilística de causalidad (ver definición precisa en la sección~\ref{}).
%
...
%
La novedad no es tanto el modelo causal de base (que se ve en detalle en el capítulo 2 y 4), el cual es tan simple que los anteriores.
%
...
Esto da cuenta de la dificultad que existe en el campo de los estudios del aprendizaje para proponer y evaluar modelos causales capaces de integrar los diversos elementos de interés que forman parte de nuestros objetos reales de estudio.
%
Por ese motivo, cuando en los capítulos 3 y 5 exploramos el efecto que algunos factores sociales tienen sobre el aprendizaje de los individuos, nos vimos obligados a recurrir a diversas heurísticas estadísticas que no garantizan conclusiones definitivas.
%
Solo recientemente, en el trascurso del doctorado apareció quizás el primer modelo causal capaz de integrar elementos que son específicos al problema de estudio~\cite{trueskill2}.
%
...
%
Antes estuv\'imos en grave peligro de extinci\'on, lo que se evidencia en la baja diversidad del genoma humano respecto incluso de los homininos m\'as cercanos~\cite{Hrdy2009}.
%
...
%
A trav\'es de rondas repetidas de coevoluci\'on gen\'etico-cultural, se fueron desarrollando las caracter\'isticas biol\'ogicas, cognitivas y sociales que nos permitien hoy aprender y transmitir rasgos culturas complejos a través de las generaciones~\cite{Jones2011}.
...
Early behaviorists believed that learning can occur only when learners actually behave in some way (perhaps when they make a response and experience the consequences of that response). But in the 1940s, some psychologists proposed that people can also learn a new behavior simply by watching and imitating what other people do (N. E. Miller & Dollard, 1941). This idea of modeling provided the impetus for an alternative perspective, \emph{social learning theory}, that focused on how people learn from observing those around them.
