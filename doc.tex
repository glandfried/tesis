...
\subsection{La comunidad bayesiana de América Latina}

%
El hecho de que las reglas de la probabilidad garanticen actualizar las creencias preservando el principio intercultural de no mentir (de maximizar incertidumbre dada la información disponible) hace que éste sea el sistema de razonamiento general, de toda ciencia empírica, en especialmente en aquellas áreas donde la verdad tiene un valor vital como en las áreas de la salud, forense y apuestas.
%
Además, no solo es una respuesta epistemológica, es fundamentalmente una respuesta metodológica que ofrece un procedimiento concreto para actualizar las creencias de forma óptima (la regla del producto) y predecir con la contribución de todas las hipótesis (la regla de la suma).
...
%
Si bien los obstáculo que existían sobre la aplicación estricta de las reglas de la probabilidad han sido levantados en la Era de la computación electrónica, la inercia histórica hace que su desarrollo siga siendo incipiente, especialmente en los países periféricos como el nuestro.
%
La adopción del enfoque bayesiano en zonas periféricas de nuestro país y de nuestro continente, y en ciencias con menor formación en matemática y programación como las ciencias sociales, es en la inmensa mayoría de los casos inexistente.
...
para realizar finalmente la transición científica probabilística, no existe todavía una condición material previa: una comunidad bayesiana lo suficientemente densa que la impulse.
%
...
\subsection{La organización de Bayes Plurinacion y el Congreso 2023}
...
\todo[inline]{Curso verdades empíricas}
...
\section{Verdader relevantes} \label{sec:volverAlFuturo}
