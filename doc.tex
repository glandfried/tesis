...
%
Hay que incorporar la información que transmite la observación de una hipótesis elemental en las restantes $2^N-2$ combinaciones a través del grado de sorpresa asociada a los supuestos iniciales (el modelo, conjunto de restricciones formales), la cantidad de creencias asignada por los supuestos a la hipótesis elemental observada con anterioridad a ser observada (predicción a priori).
%
En casos más complejos, que involucran además preguntas (o hipótesis) de investigación con graduaciones continuas ni siquiera posible cuando las integrales requeridas para la aplicación de la regla de la suma no tiene solución analítica.

% Parrafo

El famoso modelo lineal es un caso paradigmático en la historia de la probabilidad, es un modelo que tiene solución analítica que no pudo ser evaluado correctamente hasta el desarrollo de la computación moderna debido al costo computacional de la inversión de matrices.
%
