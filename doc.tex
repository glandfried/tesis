...
% % 
% % % 
La ruptura de la coexistencia ecológica actual, producto de la masiva pérdida de diversidad cultural durante la colonial-modernidad, está produciendo una masiva pérdida de biodiversidad, una crisis ecológica sin precedentes.
% % % %
% % % 
% % % 
Quizá la coexistencia sea la única estrategia evolutivamente estable, y quienes la rompan sufran tarde o temprano las consecuencias.
...
En la sección anterior vimos que en los sistemas multiplicativos es posible aumentar la tasa de crecimiento a través de la cooperación y la especialización.
%
La pregunta es: ¿Es posible la coexistencia entre entidades cooperativas y especializadas con linajes no cooperativos?
%
¿O la optimización de la tasa de crecimiento a través de la cooperación y la especialización produce invariablemente la ruptura de la coexistencia?.

% Parrafo

Para responder esta pregunta a 
