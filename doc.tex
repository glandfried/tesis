...
\end{equation}
%
Para demostrarlo, descomponemos el conjunto $D$ como la uni\'on (suma) de la intersecci\'on (producto) del conjunto $D$ con cada hip\'otesis de investigaci\'on $H_i$.
%
\begin{equation*}
