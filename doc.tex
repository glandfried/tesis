...
\section{Construcción del dato de base empírica metodológica \emph{Habilidad}.} \label{sec:base_empirica_metodo}
...
El modelo causal propuesto por Elo para estimar la habilidad de los ajedrecistas profesionales es conceptualmente simple.
%
La figura~\ref{fig:generative_model} vemos una versión ``Gaussiana'' del modelo causal en el que las habilidades ocultas generan el resultado observable a través de desempeños aleatorios.
%
\begin{figure}[ht!]
  \centering
  ...
  \begin{subfigure}[b]{0.375\textwidth}
    ...
    %
    El área bajo de un lado y del otro de la diagonal es la predicción del resultado.
    }
\end{figure}
%
