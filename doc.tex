...
%
Por ejemplo, tal como hab\'iamos mencionado anteriormente, podemos contar con la pista indicada por el or\'aculo. 
...
\todo[inline]{Arreglé el parrafo anterior para hacerlo coherente con haber introducido la pista un cachito antes, como estaba parecía que recien ahora te aparece esa informaci\'on y en realidad, recien ahora la consideras}
%
...
\end{figure}
%
Si bien ambas respuesta son diferentes, ellas comparten la propiedad de ser la distribuci\'on de probabilidad honesta dadas las restricciones.
%
