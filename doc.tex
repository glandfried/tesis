...
\end{figure}
%
Si modificamos levemente el valor inicial de la poblaci\'on bajo un comportamiento ca\'otico (por ejemplo de $0.5$ a $0.499$) obtenemos trayectorias que r\'apidamente divergen entre s\'i, siendo completamente diferentes una decena de pasos temporales (figura~\ref{fig:sensibilidad}).
%
\begin{figure}[ht!]
    \centering
...
Antes de su definici\'on formal, esta idea ya era discutida en el siglo 18 por los fundadores de la teor\'ia de la probabilidad bajo el nombre de \emph{principio de indiferencia}~\cite{jaynes1984}.
%
