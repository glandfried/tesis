...
Las especie humana tiene una singular capacidad de aprendizaje social, que le permite acumular soluciones sucesivas en el tiempo que van produciendo el inimaginablemente complejo sistema de informaci\'on cultural.
%
Si bien el aprendizaje humano ocurre en los cuerpos biol\'ogicos, el aprendizaje cultural es fen\'omeno poblacional que emerge en la interacci\'on prolongada entre individuos y entre generaciones.
%
...
Entender las relaciones que vinculan el nivel poblacional (como la din\'amica y estructura de la red de intercambios de informaci\'on cultural)
...
%
Para ello, decidimos estudiar las comunidades de videojuegos en l\'inea.
%
...
%
Para evaluar algunas de estas hip\'otesis, decidimos estudiar en el tiempo la evoluci\'on de la habilidad al interior de comunidades de videojuegos en l\'inea.
%
Las comunidades virtuales son un lugar privilegiado para estudiar
c\'omo cambian las estrategias en el tiempo, al mismo tiempo que ofrecen la posibilidad de estudiar poblaciones suficientemente grandes con un alto grado de detalle, lo que no se logra con ninguna de las metodolog\'ias cl\'asicas de las ciencias sociales (censo, encuesta, etnograf\'ia).
%
...
\end{equation}
\todo[inline]{Me parece que falta un poquito de contexto e intuici\'on para explicar qu\'e significa, una oracion dando qu\'e significa en terminos del modelo, tipo que refleja que no sea una constante, sino un valor que puede variar y esa variacion se puede deber a distintas circunstancias}
%
...
\todo[inline]{Seguro que el 2/3 tiene unidad? No es una probabilidad?}
