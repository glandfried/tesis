...
\todo[inline]{Que poblacion est\'a incluida en la subfiguras?}}
...
\todo[inline]{se estaba refiriendo al panel superior derecho de la figura y en esa ubicaci\'on no hay nada, lo cambi\'e a izquierdo}
%
...
\todo[inline]{se estaba refiriendo al panel inferior izquierdo de la figura y en esa ubicaci\'on no hay nada, lo cambi\'e a derecho}
%
...
\end{equation}
\todo[inline]{Tenes que explicar la ecuaci\'on, que es cada termino y variable}
%
...
La interfaz de los paquetes no exhibe ninguna diferencia entre partidas de dos equipos o de varios equipos, como se puede ver en los c\'odigos de ejemplo~\ref{lst:game} y \ref{lst:multiple_team_game}.
%
