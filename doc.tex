...
%
Por ejemplo, si en cada paso temporal luego de apostar los individuos de un grupo de tamaño $N$ redistribuyen los recursos en partes iguales, la riqueza de los individuos pasa a ser el promedio de todos los recursos luego de que $m_c$ y $m_s$ individuos obtienen Cara y Seca respectivamente, con $m_c + m_s = N$.
...
%
Cuando el tamaño del grupo tiende a infinito, la puesta óptima es apostar todo a la mejor opción, $b^* =1$.
%
\begin{equation}
\lim_{N \rightarrow \infty} r(N,b) = p \,  Q_c  \, b + (1-p) \, Q_s  \, (1-b)
\end{equation}
%
Sin embargo, la especialización emerge incluso en grupos pequeños.
%
...
\subsection{La transición cultural mayor}

Las propiedad de los procesos de selección multiplicativo produce una tendencia permanente hacia la emergencia de agregaciones cooperativas de nivel superior tanto en probabilidad, mediante la cooperación predictiva de hipótesis de nivel inferior, como de evolución, mediante la cooperación de recursos entre los individuos de un grupo.
%
Esta fuerza que lleva a las entidades capaces de autorreplicación a formar parte de unidades cooperativas superiores se conoce en evolución como transiciones evolutivas mayores y podría ser llamada en probabilidad como \emph{transiciones epistémicas mayores}.
%
...
En la historia del ser humano la cooperación epistémica (transmisión de conocimiento en entre individuos) permitió la emergencia de cosmovisiones, como la ciencia y la cultura, donde paradigmas altamente especializados en dominios particulares coexisten.
%
Los efectos positivos son evidentes.
%
Antes de la transición cultural, estábamos en grave peligro de extinción, lo que se evidencia en la baja diversidad del genoma humano, respecto incluso de los homininos más cercanos.
%
...
\todo[inline]{Poblamiento}

% Parrafo

Si bien varias especies animales son capaces de desarrollar tradiciones simples, y en algunas (como las ballenas, delfines, primates y aves) las tradiciones llegan a ser bastante complejas, todas ellas son manifiestamente más simples que la cultura humanas.
%
...
%
Por el contrario, para que evolucionen estas características innatas es necesario la presencia previa de alguna lenguas primitiva que proporcionara una entorno cultural que presionara a favor de la selección de mejores habilidades lingüísticas innatas.
%
