...
\subsection{Entropía o tasa de información}
...
La información de Shannon (en órdenes de magnitud) se define como el negativo del logaritmo de la predicción.
%
Si la predicción es 0, tenemos información infinita.
%
Si la predicción es 1, tenemos información nula.
%
Luego, la entropía se define como la esperanza.
%
\begin{equation*}
