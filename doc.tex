...
%
Sin embargo, la aplicación estricta de las reglas de la probabilidad exige propagar la información en todas las direcciones, incluso del futuro al pasado.
%
De esta forma TrueSkill Through Time~\cite{Dangauthier2007} consigue estimaciones precisas con baja incertidumbre, incluso al principio de cada serie temporal.
%
...
%
A través de nuestro software de código abierto, en \texttt{Julia}, \texttt{Python}, y \texttt{R}, obtenemos las habilidades iniciales de los individuos, lo que nos permite evaluar el efecto de la red en los procesos de aprendizaje.
