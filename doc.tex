...
%
Una funci\'on de probabilidad asigna una proporci\'on de la creencia (un n\'umero entre 0 y 1) a cada posible hip\'otesis $h$.
%
...
%
Si adem\'as el espacio de hip\'otesis es exhaustivo la suma debe ser 1, pues estaremos sumando la creencia que asignamos a todas las posibles hip\'otesis.
%
...
% %
% Las ciencias emp\'iricas, desde la f\'isica hasta las ciencias sociales, deben validar sus proposiciones en sistemas abiertos que contienen siempre alg\'un grado de incertidumbre.
%
...
%
Adem\'as, podemos sospechar que existe una segunda relaciones causal, según la cual la pista tampoco est\'a habilitada a abrir la caja que elegimos $s \neq c$ (figura \ref{fig:modelo_causal_2}).
...
%
Este último sistema axiom\'atico es el m\'as utilizado por su simplicidad matem\'atica y en su versi\'on original dice,
%
\begin{quotation}
