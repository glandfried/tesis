...
\section{Aplicaci\'on estricta de las reglas de la probabilidad}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{
    Evaluaci\'on de modelos alternativos
    }
    \label{fig:monty_hall_selection}
\end{figure}
%
...
%
Con hip\'otesis que toman discretos, por ejemplo, el tama\~no de la distribuci\'on conjunta crece de forma exponencial en funci\'on de la cantidad de variable $n$ y la cantidad de estados $e$ que pueden adquirir las variables $e^n-1$.
%
