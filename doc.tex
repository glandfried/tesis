...
%
Estas reglas son conceptualmente intuitivas: preservar la creencia previa que sigue siendo compatible con los datos (regla del producto) y conservar la creencia durante su distribución y recuperación (regla de la suma).
%
...
En las últimas décadas se fueron desarrollando técnicas que permiten aprovechar toda la potencia del aprendizaje automático probabilístico~\cite{murphy-pmlBook1,murphy-pmlBook2} de forma flexible e intuitiva, permitiendo crear modelos personalizados a la medida de cada problema específico.
%
...
La posibilidad actual de especificar modelos causales probabilísticos a partir de los argumentos causales expresados en lenguaje natural es necesidad tanto para las ciencias sociales como para el área de aprendizaje automático y ciencia de datos que trabaja problemas sociales.
%
...
Si bien ya existen las herramientas para realizar finalmente la transición científica probabilística, no existe todavía una condiciones materiales previa: comunidad bayesiana lo suficientemente densa que la impulse.
%
Este diagnóstico lo fui desarrollando a partir de la segunda mitad del doctorado.
%
A partir de la falta de referentes bayesianos en la propia facultad, comencé un proceso de búsqueda activa.
%
Antes de la pandemia tuve la suerte de conocer a al Grupo de Modelado Probabilístico, uno de los equipos bayesianos más importantes de la Argentina, que participan activamente en el desarrollo de por ejemplo el lenguaje de programación probabilística de Python \texttt{pymc}.
%
...
Al haber verificado la debilidad de la comunidad bayesiana en Argentina, al final del doctorado comencé a organizar con algunos de sus protagonistas el primer Congreso Bayesiano Plurinacional en colaboración con la Secretaría de Ciencia y Tecnología de Santiago del Estero.
%
El congreso se realizó en Santiago del Estero los días 4, 5 y 6 de agosto del 2023.
%
...
%
Como consecuencia hemos logrado que actualmente existe una activa comunidad bayesiana, con miembros de diversos países, que continúa organizando actividades presenciales como la Escuela Bayesiana Plurinacional, y virtuales como el seminario Verdades Empíricas.

% Parrafo

Fueron tres los elementos claves para el éxito del congreso.
%
El primero ya fue mencionado, y tiene que ver con la importancia histórica del enfoque bayesiano y el contexto actual de crecimiento incipiente a nivel mundial.
%
...
%
Y el tercero, fue el desarrollo de un software que realicé para la organización, que nos permitió crear la red de co-autorías bayesianas de latino América (artículos científicos que tuvieran al menos una afiliación en latino America y alguna palabra claves en el título o abstract vinculada al enfoque bayesiano) y contactar personalmente a la mitad de los investigadores de la comunidad.
%
Así pudimos verificar que la comunidad es más grande de lo que creíamos (Autores individuales primeros en los 5 países: Brasil 9501, Mexico 3276, Argentina 1640, Chile 1295, Colombia 1069).
%
Sin embargo, a través del contacto directo pudimos verificar que la comunidad está muy desconectada, sus protagonistas no se conocen todavía.
...
\section{Interdisciplina, ciencia de datos e incertidumbre} \label{sec:doctorado}
