...
El epistem\'ologo Juan Samaja~\cite{Samaja1999} propone una estructura invariante del emp\'irico.
%
Todo dato emp\'irico est\'a compuesto por: una hip\'otesis de investigaci\'on oculta de inter\'es ($H$), una hip\'otesis de investigaci\'on observable ($D$) vinculada a la hip\'otesis oculta de inter\'es, un procedimientos de medici\'on ($P$) que produce se\~nales que se incorporan a la base emp\'irica epistemol\'ogica ($B$) mediante la cual se infiere o estima el valor de verdad ($V$) o probabilidad de las hip\'otesis elementales de la hip\'otesis oculta $H$.
%
Cada uno de estos elementos del dato emp\'irico forma parte de un camino que nos lleva de lo abstracto a lo concreto y de lo concreto a los abstracto.
%
\begin{figure}[H]
    \centering
\tikz{
