...
\includegraphics[scale=.8]{img/logofcen.pdf}
...
%
El crecimiento de sus linajes siguieron procesos multiplicativos y ruidosos: secuencias de tasas de supervivencia y reproducción.
%
Los errores en la replicación diversificaron las formas de vida, y las distintas tasas de crecimiento favorecieron a aquellas mejor adaptadas al ambiente.
%
La vida adquirió así una extraordinaria complejidad, tanto a nivel de cooperación como de especialización.
%
Hoy el 82\% de la biomasa son plantas, 13\% bacterias, y solo 0.36\% animal.

% Parrafo

La evolución funciona como un sistema de procesamiento distribuido de información.
%
Las unidades de información genética se trasmiten a través de las generaciones por ser útiles para la reproducción y la supervivencia.
%
Nuestro linaje estuvo en grave peligro de extinción, que se evidencia en la baja diversidad del genoma humano.
%
La aparición de la crianza cooperativa favoreció la selección de jóvenes más capaces para la comprensión mutua, la imitación y el aprendizaje social.
%
Los conocimiento adquiridos por simple experiencia individual comenzaron a ser transmitido a la siguiente generación.
%
...
Como consecuencia de la naturaleza multiplicativa de los procesos de selección biológica y cultural, las fluctuaciones tienen un efecto negativo en la tasa de crecimiento debido a que los impactos de las pérdidas son más fuertes que los de las ganancias: un único cero en la productoria alcanza para generar la extinción.
%
Individualmente las fluctuaciones se reducen cuando ``ponemos los huevos en distintas canastas''.
%
Sin importar los ``pagos que ofrezcan'' los distintos estados del ambiente, la tasa de crecimiento individual se maximiza siempre dividiendo los recursos en la misma proproción que su frecuencia típica.
%
La tasa de crecimiento puede aumentarse más si también se reducen las fluctuaciones a través de la cooperación.
%
Y aún más, apenas surge la cooperación, aparece una ventaja todavía mayor a favor de las estrategias que ponen todos sus recursos en el estado ambiental más frecuente.
%
Estas propiedades de los procesos multiplicativos explican por qué las cooperación y la especialización son tan comunes en la historia de la vida. 

% Parrafo

La inferencia Bayesiana se fundamentan en un criterio intercultural de acuerdos intersubjetivos conocido como ``principio de indiferencia''.
%
En ausencia de información previa, todos vamos a estar de acuerdo en dividir las creencias sobre un conjunto de hipótesis contradictorias en partes iguales.
%
El ``principio de indiferencia'' garantiza entonces un primer acuerdo intersubjetivo en contextos de incertidumbre, lo que constituye la base de las verdades empíricas.
%
El ``principio de coherencia'', a su vez, actualiza las creencias preservando la creencia previa que sigue siendo compatible con los datos.
%
Debido a que en los proceso multiplicativo de selección, la hipótesis, que se maximiza dividiendo los recursos en la misma proproción que su frecuencia típica, lo que garantiza el conocimiento empírico.
% %
% La corriente Bayesiana de la teoría de la probabilidad no es más que el ``principio de indiferencia'' que sigue siendo compatible con la evidencia formal y empírica (modelos causales y datos).
