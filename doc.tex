...
\section{Tecnologías de reciprocidad epistémico-evolutivas}
...
%
La simbiosis entre entre plantas y hongos micorrícicos arbusculares (MA) es el mutualismo más extendido del mundo.
%
La gran mayoría de las plantas terrestres forman interacciones AM, en las que las plantas suministran a los hongos AM asociados carbohidratos, esenciales para la supervivencia y el crecimiento de los hongos \cite{parniske2008-arbuscularMycorrhiza}.
%
A cambio, los hongos MA proporcionan a sus plantas hospedadoras nutrientes minerales, como fósforo o nitrógeno, y otros beneficios como protección contra el estrés biótico (patógenos y herbívoros) y abiótico (por ejemplo, sequía)~\cite{smith2010-arbuscularMycorrhizas}.
%
A esta asociación, que evolucionó mucho antes que los mutualismos entre insectos o vertebrados, se le atribuye el mérito de haber impulsado la colonización de las plantas en la tierra, permitiendo la transferencia masiva de nutrientes a escala mundial.
%
En esta relación, ambas partes interactúan con múltiples socios y la cooperación se estabiliza en ambas direcciones a través de recompensas mutuas por los servicios de mayor calidad~\cite{kiers2011-reciprocalRewards}.

\todo[inline]{seguir}

% Ocultas a nuestros ojos, las raíces de las plantas están colonizadas por un hongo llamado micorriza arbuscular. Las raíces y los hongos forman complejas redes subterráneas para intercambiar recursos esenciales. A diferencia de las economías humanas, que dependen de la cognición para tomar decisiones, los comerciantes de este mercado subterráneo regatean, piden prestado y hacen trampas, todo ello sin pensar. (Toby Kiers)

% Outside humans, true agriculture was previously thought to be restricted to social insects farming fungus. \cite{mueller2005-insectsAgriculture, campbell2022-antsPlantCultivation}




forman parte de una de las asociaciones simbióticas más importantes y ampliamente
distribuidas de las plantas


%

Así es que la experiencia acumulada por las comunidades humanas alrededor del mundo condujo a una obligación universal de dar y de recibir~\cite{mauss1923-leDon}, y al desarrollo de tecnologías de reciprocidad que tienen la función de re-activar los vínculos comunitarios mediante ritos (festivos o coercitivos) de intercambios~\cite{zaffaroni2013-cuestionCriminal, segato2016-guerraContraLasMujeres}.
%
Estas tecnologías de reciprocidad han emergido de forma independiente a través de las generaciones debido a que favorecen la supervivencia de las comunidades en el tiempo, gracias a que reducen las fluctuaciones individuales que ponen en peligro la estabilidad del grupo.
...
%
Por otro lado, ofrecer pagos inversos a la probabilidad ($Q^*_{\text{rojo}} = p_{\text{rojo}}^{-1} $, $Q^*_{\text{azul}} = (1-p_{\text{rojo}})^{-1}$) garantiza a la coexistencia entre una casa de apuestas y un conjunto infinito de individuos cooperativos.
%
\begin{equation}
\cancel{p_{\text{rojo}}} \,  \cancel{Q^*_{\text{rojo}}} \, b + \bcancel{(1- p_{\text{rojo}})} \, \bcancel{Q^*_{\text{azul}}}  \, (1-b) = b + (1-b)  = 1
\end{equation}
%
Sin importa la apuesta $b$ que se elija, la tasa de crecimiento de un grupo cooperativo de tamaño infinito es siempre 1.

% Parrafo

Las tecnologías de reciprocidad reales, capaces de administrar la vida común, siempre han emergido de la coexistencia estable con los sistemas ecológicos locales, lo que garantiza la supervivencia de ese pueblo y esa cultura en el tiempo.
%
Los pueblos que practican la coexistencia intercultural y ecológica exhiben lógicas ``plurales y condicionales'' cualitativamente similares a la de la aplicación estricta de la probabilidad, que fomentan la convivencia con otras formas de vida, otros pueblos y otros conocimientos~\cite{segato2018-manifesto}.
%
El remplazo repentino de estos sistemas culturales locales por instituciones externas, tanto privadas como públicas, que exhiben lógicas ``singulares y definitvas'' cualitativamente similar al lenguaje tradicional de la ciencia colonial-moderna, ha producido devastadoras consecuencias ecológicas~\cite{segato2013-colonialidad, ostrom2010}.
%
...
La descendencia, mutaci\'on y selecci\'on de la informaci\'on cultural se produce cuando una persona adopta el comportamiento de otras, sea porque es el comportamiento de la mayor\'ia, sea porque la otra persona es particularmente exitosa o prestigiosa o por otros motivos~\cite{laland2004-socialLearningStrategies, rendell2010-socialLearningTournament, Boyd2011, heyes2016-whoKnows}.
% %
Todos los procesos de aprendizaje social modifican en alg\'un grado la variante cultural adoptada, y algunas de esas ellas se propagan m\'as r\'apido o son m\'as estables que otras, predominando en el tiempo.
...
En esta tesis nos proponemos estudiar el efecto que la interacción social tienen sobre el aprendizaje individual.
%
...
El objetivo fundamental de este tesis consiste en utilizar datos masivos para analizar el comportamiento cooperativo en sociedades de seres humanos que interact\'uan en contextos virtuales competitivos como juegos en l\'inea.
%
La masificaci\'on de las computadores personales y la posterior expansi\'on de Internet produjo una explosi\'on en la cantidad y calidad de datos generados por personas en todo el mundo.
%
La enorme cantidad de informaci\'on abre nuevas posibilidades y desaf\'ios tanto para las ciencias de la computaci\'on como para las ciencias sociales.
%
En la intersecci\'on de ambas, ha surgido una nueva sub-disciplina, las \emph{ciencias sociales computacionales}~\cite{Lazer2009, Lazer2020}.
%
%Esta tesis se enmarca en esta nueva forma de interdisciplina, que pone a prueba los modelos en base al desempeño que tienen sobre datos reales.
%
...
Es importante reconocer las particularidades que suponen el estudio de comunidades virtuales en oposici\'on a las comunidades reales.
%
Las primeras se desarrollan en un medio virtual que determina el contexto de los actos y limitan el conjunto de acciones y se\~nales que las personas pueden ejecutar.
%
Sin dejar de tener en cuenta estas y otras caracter\'isticas propias a las comunidades virtuales, es necesario reconocer que ellas son manifestaciones propias de los humanos.
%
Y como tales, su estudio es un medio para analizar como el comportamiento social emergente de los seres humanos.
%
Dada la calidad de los datos que ofrecen las comunidades virtuales en oposici\'on a otros contextos de investigaci\'on social, creemos que ellas son especialmente ricas para estudiar una serie de problemas que requieren todav\'ia soluci\'on, como son los procesos de formaci\'on de alianzas \cite{pena2012-secondaryMechanismsEvolutionCooperation, yaari2010-cooperationEvolution}, la din\'amica de las estructuras de red social~\cite{mason2012-experiment,salali2016-knowledgeSharing}, la difusi\'on de ideas y aprendizaje social~\cite{mcelreath2008-outsideLaboratorySocialLearningStrategies, mesoudi2016-individualAndCulturalVariationSocialLearning}, la evoluci\'on de los comportamientos~\cite{muthukrishna2014-experiment,migliano2020-model} entre otras.

% Parrafo

Uno de los cuerpos de hip\'otesis te\'oricas mejor establecidos para explicar las clases de soluciones que pueden aplicar las sociedades al problema de la cooperaci\'on provienen del campo conocido como \textit{evoluci\'on de la cooperaci\'on}.
%
Es b\'asicamente una teor\'ia de juegos evolucionaria~\cite{maynardsmith82} que modela las interacciones sociales como juegos, partir del cual las diferentes estrategias se replican en la sociedad en diferente proporciones y mutan con distintas velocidades.
%
Una corriente importante de estos trabajos, utilizan modelos matem\'aticos y simulaciones para explicar y predecir la evoluci\'on de la estrategias humanas de interacci\'on social, poniendo especial \'enfasis en las condiciones que requieren las estrategias cooperativas para emerger y sostenerse en el tiempo.
%
Estos trabajos son, esencialmente, modelos formales te\'oricos que poseen poca o nula corroboraci\'on emp\'irica.
%
Se plantea, entonces, una fuerte necesidad de avanzar en este sentido.

% Parrafo

Este plan de tesis propone poner a prueba algunas de estas hip\'otesis bas\'andose en la disponibilidad de una masiva cantidad de datos generados d\'ia a d\'ia en comunidades virtuales competitivas y en particular en los juegos en l\'inea multijugador de tipo estrat\'egico de mediana y larga duraci\'on.
%
El plan de tesis tiene como objetivo particular poner a prueba algunas de estos desarrollos te\'oricos bas\'andose en la disponibilidad de una masiva cantidad de datos generados en comunidades virtuales competitivas y en particular en los juegos en l\'inea multijugador de tipo estrat\'egico de mediana y larga duraci\'on.
%
El plan se enfoca en temas de computaci\'on y, en particular, en las t\'ecnicas de an\'alisis de datos, con el objetivo de resolver temas profundamente antropol\'ogicos, en particular el problema de la evoluci\'on de los comportamientos cooperativos en contextos de competencia en comunidades de seres humanos.
...
\cite{Beheim2014}
\cite{mesoudi2020-footballTactics}
\cite{brand2019-songLyrics}


----------------------

En los \'ultimos $10$ a\~nos, se comenzaron a estudiar los juegos en l\'inea multiusuario como fuente de datos.
Uno de los aspectos estudiados corresponde con el an\'alisis de las propiedades estructurales de las redes de jugadores~\cite{szell,Szell12a,thurner,son,Grabowski2007,Grabowski2009}.
En los trabajos de Szell et al.~\cite{szell,Szell12a} se analizan la estructura de redes de amistad, enemistad y comunicaci\'on con las que eval\'uan una serie de hip\'otesis sociol\'ogicas.
En Thurner et al.~\cite{thurner} se estudia la correlaci\'on de ocho tipos de acciones de intercambio, las de comunicaci\'on, comercio, establecimiento de amistad y enemistad, ataques y castigo.
En Son et al.~\cite{son} se presenta un an\'alisis de redes que considera los aspectos contextuales que afectan la interacci\'on.
En Grabowski y Kruszewska~\cite{Grabowski2007} se compara la estructura de la red de los juegos con las redes sociales interpersonales reales.
En Grabowski~\cite{Grabowski2009} se calcula como el tiempo invertido en la interacci\'on con otros jugadores afecta la formaci\'on de opiniones.

Otro conjunto de art\'iculos investiga el rol de la confianza en la estructura de la red y en otros aspectos del sistema social~\cite{roy,subbian,ahmadThesis}.
En Roy y Srivastava~\cite{roy} se proponen dos modelos predictivos, uno sobre colaboraci\'on, comercio y agrupamiento, y otro sobre formaci\'on de confianza calculada en funci\'on de la topolog\'ia de la red.
En Subbian et al.~\cite{subbian} se estudia la reciprocidad en cuatro clases de redes, de confianza, de conversaciones, de comercio, y de colaboraci\'on. En Ahmad et al.~\cite{ahmadThesis} se analiza el efecto del medio social en las relaciones amistosas y conflictivas y en la formaci\'on de lazos.

Una serie de publicaciones analizan formaci\'on de grupos \cite{chen,huang09b,huang09a}. En Chen et al.~\cite{chen} se investiga como los jugadores se incorporan y abandonan alianzas para descubrir los factores del juego que incentivan su formaci\'on y desarrollo. En Huang et al.~\cite{huang09b} se examinan combates grupales para identificar roles de los jugadores. En Huang et al.~\cite{huang09a} se estudia el impacto de la homofilia y de la proximidad offline en las interacciones entre jugadores.

Otra l\'inea de trabajos busca comprender las variables que determinan el desempe\~no de los usuarios \cite{delong,shim,shim11b,orkin} En DeLong et al.~\cite{delong} se eval\'uan m\'etricas de rendimiento y se propone un modelo para estimar la habilidad de equipos de jugadores.
En Shim et al.~\cite{shim} se presentan modelos de predicci\'on de rendimiento de los jugadores y estudian los efectos de los tutores sobre el rendimiento de juego.
En Orkin y Roy \cite{orkin} se introduce un modelo de aprendizaje de patrones contextuales sensibles para el comportamiento y el lenguaje natural.

Algunos art\'iculos buscan entender los motivos por los cuales los jugadores abandonan o ingresan a los juegos~\cite{wei,Mahmassani,teng,borbora}.
En Wei et al.~\cite{wei} se examina el rol de los jugadores individuales y colectivos en la difusi\'on de dos juegos muy populares.
En Mahmassani et al.~\cite{Mahmassani} se estudia la frecuencia de las sesiones, las momentos de inicio y fin y su duraci\'on.
En Teng y Adamic~\cite{teng} se analiza una serie de variables como la red social, la afiliaci\'on, las conversaciones y transacciones con el objetivo de predecir los jugadores que abandonan el juego y los que contin\'uan.
En Borbora y Srivastava~\cite{borbora} se estudia el comportamiento de los jugadores que abandonan los juegos semanas antes de retirarse definitivamente y la comparan con la actividad de jugadores normales.

Finalmente en Ahmad y Srivastava~\cite{ahmad14} se revisan algunas de las t\'ecnicas m\'as apropiadas para el estudio de los juegos en l\'inea multiusuario y para el desarrollo de modelos predictivos y generativos.
