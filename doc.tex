...
En evolución, el crecimiento de una estrategia $e$ en el tiempo, $\omega(t)$, esta gobernado por una secuencias estocástica de tasas de supervivencia y reproducción $f_e(\cdot)$ dependientes de un ambiente aleatorio $a$,
%
...
En el límite, $T \rightarrow \infty$ todas las trayectoria individuales estarán determinadas por el mismo factor efectivo $\overline{f_e}$ por el que se multiplica los recursos $\omega_e(T)$ en cada iteración.
\begin{equation}
\begin{split}
