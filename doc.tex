...
\todo[inline]{Esta bueno, yo pondr\'ia el ejemplo puntual del paper de aves expandiendo lo que encuentran ah\'i, creo que le dar\'ia un poco m\'as de solidez}
%
Sin embargo, todas ellas son manifiestamente m\'as simples que la cultura humana.

% Parrafo

Lo singular de la especie humana es la capacidad de acumular adaptaciones culturales en el tiempo, modificaciones sucesivas que van produciendo un sistema de informaci\'on cultural inimaginablemente complejo.
%
...
%
La cultura humana es la informaci\'on transmitida por v\'ia comportamental, y la sociedad humana el sistema distribuido de almacenamiento y procesamiento.
\todo[inline]{Esta \'ultima frase es fuerte, si no tenes una cita y es opinion tuya, tiene que ir a la parte de discusion en todo caso, sino pone la cita que te banque}
...
Luego de haber extendido la frontera de los modelos de estimaci\'on de habilidad disponibles en los lenguajes de programaci\'on, y haberlo utilizado para explorar casos reales, finalizamos la tesis con un an\'alisis te\'orico de las propiedades de los aprendizajes epist\'emicos y evolutivos.
%
Por aprendizaje epist\'emico nos referimos a la actualizaci\'on de creencias que se produce aplicando estrictamente las reglas de la probabilidad, y por aprendizaje evolutivo nos referimos a la selecci\'on de las formas de vida que se produce en evoluci\'on.
%
...
En el cap\'itulo~\ref{ch:epistemico} veremos que debido a que los procesos evolutivos de selecci\'on de las formas de vida (por secuencia de tasas de supervivencia y reproducci\'on) son como los procesos de selecci\'on de las hip\'otesis en la teor\'ia de la probabilidad (por secuencias de predicciones) ambos de naturaleza multiplicativa, se produce una ventaja a favor de las hip\'otesis o formas de vida que reducen las fluctuaciones por diversificaci\'on individual, por cooperaci\'on, por especializaci\'on cooperativa, y por heterogeneidad cooperativa.
%
Si bien durante mucho tiempo se crey\'o que la evoluci\'on de la cooperaci\'on estaba condicionada por un dilema (el del prisionero), en los procesos de selecci\'on multiplicativos tal dilema no existe debido a que los individuos desertores, al aumentar las fluctuaciones de los cooperadores de quienes dependen, aumentan sus propias fluctuaciones afectando negativamente su propia tasa de crecimiento de largo plazo.
%
Estas propiedades que se derivan de la funci\'on de costo compartida por las teor\'ias de la probabilidad y de la evoluci\'on, nos permiten finalizar la tesis con una reflexi\'on general respecto de la naturaleza de los aprendizajes epist\'emicos (de las hip\'otesis) y evolutivos (de la vida).

\section{Aprendizaje humano}


El aprendizaje se define como un cambio persistente en las representaciones o asociaciones mentales como resultado de la experiencia individual o social observables a trav\'es del comportamiento.
%
...
\chapter{Teor\'ias de los aprendizajes epist\'emicos y evolutivos}\label{ch:epistemico}
...
La ciencia es una instituci\'on humana que tiene pretensi\'on de verdad: de alcanzar acuerdos intersubjetivos con validez intercultural, universal.
%
Las ciencias formales (matem\'atica, l\'ogica) alcanzan estos acuerdos derivando teoremas dentro de sistemas axiom\'aticos cerrados.
%
