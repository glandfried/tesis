...
%
Poner a prueba estas hipótesis se ha visto obstaculizado por falta de datos granulares y longitudinales sobre el comportamiento de todos los individuos de una comunidad en el tiempo y de modelos capaces de ofrecer estimaciones de habilidad inicial fiables y de garantizar la comparabilidad entre estimaciones distantes en el tiempo y el espacio.
...
%
Las comunidades virtuales ofrecen nuevos horizontes en la investigación cientı́fica sobre comportamientos sociales pues reúnen al mismo tiempo la posibilidad de estudiar poblaciones suficientemente grandes con un alto grado de detalle.
%
...
%
Sin embargo, durante la tesis fue necesario implementación el estimador de habilidad estado-del-arte en la industria del video pues todavía no se encontraba dispoinible en ninguno de los lenguajes de progrmación con mayor desarrollo como Julia, Python y R.
%
...
Este modelo de nos permitió responder preguntas relativas al aprendizaje social.
%
En primer lugar, para responder cómo la formación de grupo puede afectar al aprendizaje estudiamos un juego por turnos en el que los jugadores pueden participar individualmente o en equipos.
%
En ese juego pudimos observar que la tendencia a jugar en equipo estaba asoaciada una mejora de habilidad a largo plazo, pero que quienes jugaban ``lealmente'' con el mismo compañero aceleraba además la adquisición de la habilidad a corto plazo.
%
...
El criterio de coexistencia, como fuente de validez del conocimiento, nos obliga a rechazar la superiordad moral de subjetividades especiales o identidades particulares (criterio de autoridad).
Según este principio de reconocimiento mutuo, el conocimiento válido es aquel que se alcanza a través de una actividad constructiva de equilibrio de entre las subjetividades (acuerdos intersubjetivos).
...
En la figura~\ref{fig:poblacion} podemos ver que
\begin{figure}[ht!]
    \centering
    ...
    \end{subfigure}
    \caption{
    Tipos de atractores en un modelo causal no-lineal
    }
    \label{fig:poblacion}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \end{subfigure}
    \caption{(\subref{fig:sensibilidad}): Primeros 30 puntos de la figura~\ref{fig:poblacion_caotico}. La linea negra comienza con una población de $0.5$ y la roja de $0.499$. (\subref{fig:pseudo_aleatorio}): Primeros 2000 puntos de la figura~\ref{fig:poblacion_caotico}, $r=3.99$ y población inicial $0.5$.}
...
Cuando la incertidumbre nos impide conocer la función que gobierna el mundo, podemos todavía expresar nuestra incertidumbre utilizando funciones de probabilidad.
