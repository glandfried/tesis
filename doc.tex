...
%
Pero más allá de eso, Jaynes generaliza el antiguo principio de indiferencia, usando por Bernoulli y Laplace, por el principio de máxima entropía.
%
\begin{quotation}
...
%
Y a esas distribuciones de creencias que cumplen las podemos llamar ``verdades empíricas'', debido a que al no afirmar más de lo que saben sin dejar decir todo lo que sí saben son proposiciones válidas universalmente.
%
...
%
Los principios de integridad (no perder ni crear creencias espontáneamente) y de coherencia (preservar la creencia previa compatible con la nueva información) inducen las reglas de la probabilidad que nos permiten preservar los acuerdos intersubjetivos a medida que se incorpora nueva información.
...
%
Debido a que la teoría de toma de decisiones de Von Neumann está mal fundada, pues se base en funciones de costo ad-hoc (la utilidad esperada), durante mucho tiempo se postuló en la teoría de juegos que la evolución de la cooperación estaba condicionada por un dilema (el dilema del prisionero).
%
Sin embargo, ya en el artículo ``A new interpretation of information rate'', el colega de Shannon John L Kelly~\cite{kelly1956} se ve obligado a apartarse de la teoría de Von Neumann para resolver cuál es la apuesta óptima en proceso multiplicativos.
%
\begin{quotation}
The cost function approach [..] can actually be used to analyze nearly any branch of human endeavor.
The utility theory of Von Neumann shows us one way to obtain such a cost function.
...
\end{quotation}
%
Recientemente, el físico Ole Peters finalmente reformula de forma general la teoría de decisiones, incorporando el concepto de ergodicidad~\cite{peters2019-ergodicityEconomics, peters2021-interpretation}.
%
...
%
Decimos que lo resuelve en términos generales porque permite elegir la función costo correcta en función de la naturaleza del proceso real que queremos evaluar, más allá de los clásicos procesos multiplicativos o aditivos estudiados por la literatura.

% Parrafo

En el capítulo 1, mostramos que la evolución de la cooperación no está condicionada por un dilema justamente debido a que en los procesos de selección multiplicativos, los individuos desertores aumentan las fluctuaciones de los cooperadores de quienes dependen, aumentando por lo tanto sus propias fluctuaciones y afectando negativamente su propia tasa de crecimiento de largo plazo (\emph{propiedad mayor}).
%
Si bien ciertas coyunturas pueden favorecer a la deserción en el corto plazo (\emph{propiedad menor}), la emergencia de unidades cooperativas de nivel superior es un fenómeno permanente en la historia de la vida (transiciones evolutivas mayores).
%
La evidencia es nuestra propia vida, que depende de al menos cuatro de estos niveles para sobrevivir: la célula con la mitocondria, el organismo multicelular, el sistema social y la comunidad ecológica.
...
Pero esta tendencia hacia la agregación de unidades ocurre también con el conocimiento científico o cultural.
%
La evaluación de hipótesis en probabilidad también está sujeta al mismo proceso multiplicativo, lo que favorece que conjunto de hipótesis individuales formen variables, relaciones entre variables forman modelos causales y sistemas de modelos causales forman teorías.
%
Los sistemas de modelos causales emergen justamente porque son capaces de adaptarse a los diversos contextos, como las intervenciones, y por lo tanto tienen mejor capacidad predictiva que modelos causales simples.
%
El concepto de teorías causales.
