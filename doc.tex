...
\subsubsection{Principio de integridad (regla de la suma)}\label{sec:principio_integridad}
...
\subsubsection{Principio de no mentir (MaxEnt)}\label{sec:principio_indiferencia}
...
\subsubsection{Principio de coherencia (regla del producto)} \label{sec:principio_choerencia} % (dados los datos de base emp\'irica)
...
\subsection{Modelo de estimación de habilidad}
...
Derivación: Aprender a (enseñar a aprender)
...
\subsection{Tarea 1: Revisión de los problemas reales y conocimiento experto}

\subsection{Tarea 2: Especificación de argumentos causales}
%
...
Aproximación de la aplicación estricta de las reglas de la probabilidad
