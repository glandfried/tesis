...
%
A pesar de que existan ciertos c\'irculos filos\'oficos que pretendan poner en duda las percepciones y supuestos m\'as b\'asicos, reduciendo la base emp\'irica a un conjunto vac\'io (que Klimovsky~\cite{klimovsky1994-desventuras} denomina \emph{base emp\'irica filos\'ofica}), en la vida cotidiana el ``sentido com\'un'' es suficientes para alcanzar acuerdos sobre las entidades m\'as b\'asicas, como el precio al que ayer nos vendieron los tomates, o el resultado de la final del mundial de f\'utbol del a\~no 2022.
%
...
En la figura~\ref{fig_hui_walter_red_bayesiana} especifica el modelo mediante la notaci\'on de redes bayesianas, en su versi\'on \emph{factor graphs}~\cite{minka2008-gates, winn2012-causality}.
%
Para mostrar c\'omo funciona el modelo generamos datos sint\'eticos, simulando los diagn\'osticos de 9 test en 11 comunidades distintas en un caso complejo.
%
Incluso si generamos una muestra en la que se reporta un subconjunto de 200 casos positivos y 200 negativos seleccionados por los test de referencia imperfectos, obtenemos estimaciones de sensibilidad y especificidad buenas (salvo para los test que realizan la selecci\'on).
%
...
\end{figure}
%
Cuando existen dependencias entre tests, sin embargo, el modelo Hui-Walter puede sobrestimar o subestimar sus desempe\~nos.
%
