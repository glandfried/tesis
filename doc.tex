...
El problema hist\'orico para la aplicaci\'on estricta de las reglas de la probabilidad ha sido el costo computacional asociado a la evaluaci\'on completa del conjunto de hip\'otesis del problema de investigación (o experimento) $\mathcal{H} = \{H_1, H_2, \dots, H_N\} $.
%
Con hip\'otesis binarias $|H_i|=2$, el tama\~no de la distribuci\'on conjunta crece de forma exponencial, $2^N-1$.
%
En modelos continuos, la imposibilidad de resolver las integrales ha sido un serio obst\'aculo para aplicar la regla de la suma y por lo tanto para aplicar estrictamente las reglas de la probabilidad.
%
Solo algunos pocos modelos con solución analítica podían ser evaluados correctamente antes de la computación moderna.
%
Incluso modelos como el lineal, que tienen solución analítica fueron prohibitivos por la necesidad de invertir matrices.
...
%
En la figura~\ref{fig:modelo_lineal} se especifica las dependencias entre hipótesis mediante una red bayesiana y la definición de las probabilidades condicionales de las hipótesis.
%
