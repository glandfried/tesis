...
%
Muchos animales son capaces de transmitir no-genética, lo que produce la emergencia de tradiciones simples.
%
...
Lo singular de nuestra especie es esta capacidad acumular adaptaciones culturales en el tiempo, modificaciones persistentes y sucesivas que terminan por producir sistemas culturales inimaginablemente complejos.
%
...
%
Por lo tanto, los diversos sistemas de comunicación que fueron surgiendo a largo de la evolución humana fueron impactando directamente sobre la tasa de aprendizaje de nuestra especie y el repertorio cultural actual.
...
%
A través de rondas repetidas de coevolución genético-cultural, se fueron desarrollando las características biológicas, cognitivas y sociales que permitieron el desarrollo culturas complejas~\cite{Jones2011}.
%
Por ejemplo, las características genética que nos permiten escuchar, hablar y aprender el lenguaje serían inútiles sin lenguajes complejos para aprender.
%
Y a la inversa, para que evolucionen estas características innatas es necesario la presencia previa de alguna lengua primitiva que presionara a favor de la selección de mejores habilidades lingüísticas innatas.

%

En términos evolutivos, nuestra capacidad biológica para la comprensión mutua y la imitación (\emph{aprendizaje social}) dio inicio a un proceso inter-generacional de acumulación de innovaciones que permitió a las poblaciones humanas adaptarse rápidamente a los cambiantes contextos ambientales.
%
...
En los últimos 10 mil años, con el surgimiento independiente de la agricultura en seis regiones distintas del mundo (África subsahariana, Oriente medio, China, Oceanía, América del Norte y América del Sur), se produce una modificación en el sistema de información cultural debido al aumento progresivo de la población y el surgimiento de la escritura, que intensificaron los procesos de acumulación cultural.
%
Este cambio en el sistema de información cultural modificó la tasa de aprendizaje colectivo, haciendo de estas regiones los principales centros tecnológicos de la humanidad.
%
Para el año 1400 el mundo florecían de sociedades prósperas: china llevaba 2 milenios siendo el principal centro productivo y tecnológico del mundo; en el mundo Árabe se comerciaban estos productos desde el océano Atlántico en España, hasta el océano Pacífico en las Filipinas; el océano Pacífico estaba totalmente ocupado, y ya se habían producido intercambios entre Oceanía y América del Sur~\cite{ioannidis2020-polynesiaAmerica}; y en el jardín de la diversidad genética y cultural humana, África subsahariana, se desarrollaba entre otras, la sociedad Bantu.
...
%
La intensificación de la interconexión global a partir del uso de energías fósiles en el siglo 19 y el desarrollo de las comunicaciones electrónicas durante el siglo 20 tuvo enormes consecuencia para el desarrollo de la ciencia moderna.
%
La adopción de los smartphones a principios de este siglo, con dispositivos de comunicación instantánea, está teniendo efectos profundos sobre nuestra capacidad de aprendizaje colectivo e individual pero que todavía desconocemos sus todas sus consecuencias.
...
%
El ejemplo paradigmático es el aislamiento total que ocurrió con la separación de Tasmania del continente Australiano por la subida del nivel del mar a comienzos del Holonceno.
%
...
%
La principal hipótesis sugiere la capacidad de almacenamiento (e innovación) de tecnologías complejas requiere un tama\~no mínimo de la población, incluso en sociedades cazadoras-recolectoras~\cite{Henrich2004}.
%
De forma similar, la masiva destrucción de la diversidad cultural al interior del imperio Romano y el conflicto permanente con las sociedades vecinas, generó el aislamiento parcial de Europa occidental del sistema mundo, conduciéndola a contramano del resto del mundo a un largo proceso de involución cultural y de violencia interna conocido como Edad Media~\cite{dussel2004}.

% Parrafo

Se han propuesto muchas causas internas para explicar la prosperidad actual de Europa occidental\footnote{La ``ética protestante'' de Max Weber~\cite{weber1905-eticaProtestante}, la ``mentalidad burguesa'' de José Luis Romero~\cite{romero1967-revolucionBurguesa}, o más recientemente el ``sistema de parentesco'' de Joseph Henrich~\cite{henrich2020-weirdest}}.
%
La paradoja que no puede responder es cómo una sociedad sumida en un proceso de involución cultural único, como la feudal, pudo generar de repente el extraordinario desarrollo científico y técnico de la modernidad.
%
Sin embargo, nada de esto resulta extraño cuando se consideran las cambios que ocurrieron en los sistemas de información cultural: las enfermedades transmitidas por los exploradores feudales eliminó, al menos, a 2/3 de la población americana; y el giro geopolítico que se produce a partir de que en 1546 los exploradores feudales descubren la montaña de plata de Potosí, metal que China había incorporado recientemente como una de sus monedas oficiales.
%
Y a pesar de todo, más de dos siglos después del acceso a la plata americana, Europa occidental seguía consumiendo más productos asiáticos de los que podía exportar a Asia.

% Parrafo

Sin embargo, no todo aumento de la interconcexión es positivo.
%
Luego de la derrota de China por parte del narco-estado británico en el siglo 19, en la que pierde 1/5 de su población, comienza la ocupación de África y de otros territorios no colonizados.
%
...
%
A pesar de todos los avances, la ciencia metropolitana no es capaz de compensar la pérdida de una innumerable cantidad de sistemas milenarios de administración de los bienes comunes, y la crisis ecológica que no deja de profundizarse.

% Parrafo

El aprendizaje individual también se ve afectado por la dinámica de las ``redes culturales''.
%
...
%
La razón por la que es difícil evaluar estas hipótesis en datos del mundo real es que debemos registrar los contactos
a nivel individual, lo que suele ser difícil~\cite{Derex2020}.
%
Sin embargo, algunos estudios demuestran que las sociedades humanas suelen desarrollar redes parcialmente conectadas que maximizan la adaptabilidad al garantizar tanto contactos regulares con grupos externos como el mantenimiento de la diferenciación local~\cite{migliano2017-hunterGathererNetwork}.
...
%
% \subsubsection{Las claves del éxito}
%
