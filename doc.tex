...
\section{La vida como sistema natural de procesamiento de información}
%
%
...
\subsection{Naturaleza multiplicativa de los procesos de selección evolutiva}
...
%
\en{But, which is the characteristic growth rate $g$? }%
...
\subsection{La ventaja de la coopera\en{tion}\es{ción}}
...
\section{La cultura como sistemas social de procesamiento de información}
...
%
Sin embargo, ninguna especie a desarrollado un sistema de cultural tan complejo como el ser humamno.
...
Reviosaremos algunas de las respuestas a estas preguntas en las siguientes subsecciones.

\subsection{El aprendizaje social y la evolución cultual}
...
\section{Motivación antropológica}
...
\chapter{Metodología de las ciencias empíricas}
...
%
\en{According to what the data suggests (one win each), TrueSkill Through Time recovers the differences between skills, indicating that both players have the same skill (both posterior centered on zero).
...
\section{\en{Illustrations}Aplicaciones}} \label{sec:illustrations}
