...
\todo[inline]{Ademas, podr\'ias ser una buena idea mostrar los numeros de como vas generando la probabilidad de cada modelo, pondría tambien una tabla con las hip\'otesis elementales y c\'omo va quedan el producto}
...
\end{equation*}
\todo[inline]{Ver notacion: en el texto es W e Y mayusculas, pero en la ecuación se vuelven minusculas}
...
\todo[inline]{Esto tambien esta raro, primero decis que son variables, pero luego decis que son constantes que conoces, y que estan en un rango entre los dos infinitos? no estar\'ia viendo que informaci\'on indica que este comprendido entre menos y mas infinito, esto no sería cualquier cosa?}
%
...
\subsection{Tasa de informaci\'on de las proposiciones emp\'iricas} \label{sec:tasa_de_informacion}
...
\section{Operacionalizaci\'on de \emph{habilidad} en la industria del video juego.} \label{sec:operacionalizacion_habilidad}
...
\subsection{Antecedentes: el modelo de habilidad Elo}
