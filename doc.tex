...
\end{table}
%
Cada una de las celdas de la tabla representa una terminal de los caminos del modelo causal representados en la figura \ref{fig:caminos_pre_montyhall}.
%
...
\chapter{Sistema de estimación de habilidad para la Asociación Artgentina de Go.} \label{ch:aago}
