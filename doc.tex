...
¿Es posible mejorar el sistema de razonamiento que no tenga el problema de overfitting?
%
...
Bajo la regla del producto, las creencias se actualizan por secuencias de predicciones por lo que es la sorpresa el filtro de la creencia previa, única fuente de información.
%
...
%
Allí encontramos que la tasa de predicción temporal del sistema de comunicación correcto, medida en órdenes de magnitud, es equivalente a lo que se conoce como entropía de Shannon.
%
La entropía de Shannon no es un elemento adicional a la teoría de la probabilidad.
% %
Se desprende de ella y mide la tasa de información en órdenes de magnitud.
%
...
%Lo interesante es que, no solo nos recuerda que la sorpresa es la única fuente de información (pues bajo la regla del producto las predicciones funcionan como el filtro de la creencia previa), sino que nos ha mostrado en los hechos que el logaritmo de la predicción mide la información en bits.
...
%
Si bien este libro reproduce el teorema de Cox, en el que las reglas de la probabilidad se derivan de una axiomatización básica del sentido común, Jaynes nos ofrece una definición fundamental que nos permite definir distribuciones de creencias honestas.
%
\begin{quotation}
...
%
Debido a que la evaluación de hipótesis en probabilidad está sujeta al mismo proceso multiplicativo que favorece la agregación, observamos que conjunto de hipótesis individuales forman variables, relaciones entre variables forman modelos causales y sistemas de modelos causales forman teorías causales.
%
Las teorías son sistemas de modelos causales que se prenden y se apagan en función del contexto.
%
La característica principal de las teorías causales es su adaptabilidad al contexto y justamente una buena teoría causal es el que predice bien en todos los contextos.
%
...
%
Sin embargo podría haber otros contextos que modifican las relaciones causales entre variables.
%
Y justamente las teorías causales son las agregaciones de modelos causales que, al adaptarse a los diversos contextos, tienen mejor capacidad predictiva que modelos causales individuales.
%
Y esta agregación de hipótesis causales emerge naturalmente de la aplicación estricta de las reglas de la probabilidad~\cite{winn2012-causality,minka2008-gates}, en particular del proceso multiplicativo de evaluación de las variantes epistémicas.
