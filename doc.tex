...
El ``principio de no mentir'' permite alcanzar acuerdos intersubjetivos en contextos de incertidumbre con validez intercultural.
%
...
%
Este principio se lo conoce como ``máxima entropía dadas restricciones'' o MaxEnt, y se ha mostrado que todas las distribuciones de probabilidad de la familia exponencial cumplen ese criterio (veremos esto más adelante).

%

El caso que estamos analizado, donde s\'olo conocemos el espacio de hip\'otesis (posibles posiciones del regalo) y no tenemos m\'as informaci\'on que nos permita tener preferencia por ninguna de las opciones, vamos a estar de acuerdo en la necesidad de dividir la creencia en partes iguales.
%
\begin{figure}[ht!]
...
\end{figure}
%
Esta distribución de creencias maximiza la incertidumbre (dividiendo la creencia en partes iguales), dada la información disponibles (no se asigna creencia por fuera de las tres cajas).
%
...
%
Para ejemplificar, supongamos que nos permiten elegir una caja $c$ y que despu\'es alguien nos señala una caja $s$ y nos muestra que en su interior no está el regalo.
%
En este caso tenemos tres variables y al menos una dependencia causal, la pista $s$ no puede señalar la caja donde está el regalo $r$.
%
...
%
Siguiendo con el principio de indiferencia dividimos la creencia en partes iguales en cada una de las bifurcaciones de los caminos paralelos del modelo causal.
%
