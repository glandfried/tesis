...
%
% Nuestra hip\'otesis inicial suponía que el aprendizaje social produce un efecto de segundo orden en la adquisici\'on de habilidades.
%
...
En primer lugar, encontramos que los comportamientos orientados a equipo est\'an relacionados con una mejora significativa del nivel de habilidad a largo plazo a pesar de tener una tasa de crecimiento inicial más lenta.
%
Este resultado se aliena con las expectativas previas.
%
El \emph{aprendizaje social} es factor fundamental en los seres humanos para la adquisición de habilidades.
%
Jugar en equipo ofrece un espacio privilegiado para la socialización y la transmisión de conocimientos.
%
Pero también implica una desafío.
%
Coordinar correctamente las actividades con otros compañeros de equipo requiere la adquisición de una habilidad adicional, que puede explicar la lenta tasa de crecimiento inicial.

% Parrafo

En segundo lugar, encontramos que la estabilidad en la formación de equipos se asocia con una mejora de las habilidades a corto plazo.
%
Este resultado se alinea parcialmente con las expectativas previas.
%
Si el aprendizaje asociado a la coordinación de equipo debe renovarse cada vez que se cambia de compañeros de equipo, entonces es esperable que la estabilidad de compañeros de equipo amortigue ese impacto negativo, acelerando los efectos positivos relacionados con el aprendizaje social.
...
%
A medida que las personas juegan más partidas en equipo el aprendizaje a largo plazo es mayor.
%
Y si además de este efecto positivo, las personas forman equipo lealmente, se observa una impulso temprano de las habilidades.
%
...
Uno aspecto nos resultó sorprendente respecto de nuestras expectativas previas.
%
Antes de comenzar este trabajo esperábamos encontrar algún efecto positivo vinculado al cambiar de equipo.
%
Esta idea estaba basada en una hipótesis ingenua, que suponía que el acceso a diferentes grupos ofrecería un mayor repertorio cultural del cual aprender.
%
...
%
En particular, se afirma que un exceso en la interconexión reduce las posibilidades de innovación~\cite{Derex2020}.
%
De hecho la plataforma es en sí misma un facilitador de contacto entre personas.
%
Por el contrario, la formación de subgrupos beneficiaría el desarrollo de innovaciones~\cite{Derex2020}.
%
En este sentido, nuestro resultado se alinea con los trabajos teóricos y experimentales recientes.
...
%
En esta secci\'on mostramos los pasos para calcular la predicción a priori (o evidencia) exacta y los likelihoods exactos de una partida con dos equipos.
%
...
%
Además, acompañaremos la derivación matemática con código en \texttt{Julia}, \text{python} y \texttt{R}.
%
\begin{paracol}{3}
...
\end{lstlisting}
%
Aquí creamos $4$ jugadores mediante el método \texttt{Player()}.
...
\end{lstlisting}
%
Además, siguiendo el~\ref{eq:m_v_f} del \emph{sum-product algorithm} y la factorizaci\'on del modelo, el mensaje que env\'ia la variable $s_i$ al factor rendimiento $f_{p_i}$, $m_{s_i \rightarrow f_{p_i}}(s_i)$, es nuevamente el prior.
%
...
%
En la figura~\ref{fig:draw_a} se muestra la distribución de probabilidad de la diferencia de desempeños, $\N(d|\psi, \vartheta^2)$, junto con los tres resultados posibles.
%
\begin{figure}[ht!]
\centering
\begin{subfigure}[t]{0.48\textwidth}
 \includegraphics[width=1\textwidth]{figures/draw.pdf}
 \caption{Diferencia de desempeños}
 \label{fig:draw_a}
\end{subfigure}
\begin{subfigure}[t]{0.48\textwidth}
...
\end{equation}
%
donde $\Phi$ representa la acumulada de una Gaussiana estandarizada, con media 0 y desvío 1.
%
...
% \todo[inline]{Aca no calculas la tasa de crecimiento sino la expectativa de crecimiento a largo plazo, una tasa por definición implica una relación con el tiempo, acá estás sacando el tiempo del medio al tomar el limite y miras algo que podría ser como el estado estacionario. Ademas cambias la nomenclatura de w a r...}
% %
% \begin{equation}
% \begin{split}
...
% \end{split}
% \end{equation}
% \todo[inline]{No es claro como pasas del primer renglon al segundo, que estás aplicando?}
% %
