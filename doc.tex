...
\todo[inline]{Creo que quedar\'ia bien volver a ponerle los valores de que salen del ejemplo a esta ecuaci\'on y calcular las posterior de cada modelo, me parece que como cierre puede andar y queda claro para cerrar la explicaci\'on}
\todo[inline, color=gray]{No entend\'i}
...
%
\todo[inline]{REACOMODAR EL C\'ODIGO}
\begin{paracol}{3}
...
\end{equation}
\todo[inline]{Tenes que explicar la ecuaci\'on, que es cada cosa y la intuici\'on atr\'as}
...
\todo[inline]{Fijate que esta convenci\'on la usaste antes sin aclarar} 
...
\begin{flushright}
 ...
 \end{subfigure}
 \caption{
 En el lado izquierdo se calcula la tasa de crecimiento de los individuos en grupos de tama\~no infinito que cooperan y se especializan, apostando todos los recursos a Seca en invierno (probabilidad de la moneda $p_I = 0.2$) y a Cara en verano (probabilidad de la moneda $p_V = 0.6$).
 %
