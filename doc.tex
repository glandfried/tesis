...
\chapter{Metodología: enfoque bayesiano y modelos de habilidad.}
...
Durante el siglo 20, se desarrolla de forma independiente, una serie de técnicas que ofrecen soluciones prácticas que evitan el costo computacional asociado a evaluar todo el espacio de hipótesis.
%
En esta época se desarrollan métodos frecuentistas que seleccionan una única hipótesis mediante funciones de costo ad-hoc (e.g~como máxima verosimilutd).
%
...
%
Por primera vez desde el descubrimiento de la teoría de la probabilidad, comienza a ser posible en todos los campos de las ciencia resolver la inferencia de los modelos probabilísticos aplicando estrictamente las reglas de la probabilidad, evaluando todo el espacio de hipótesis.
