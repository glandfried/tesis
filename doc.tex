...
En este capítulo tiene por objetivo revisar este y otros lugares comunes.

Primero, proponemos considerar a la vida como la principal fuente conocimiento empírico en tanto las diversas formas que ella adquiere en el curso de la evolución contiene información capaz de interectuar con el medio y sobrevivir.
...
En el capítulo \ref{ch:iso} mostraremos que la naturalez multiplicativa de los procesos de selección son la causa que genera sistemáticamente esta emergencia irreversible de la cooperación y la especialización.

% Parrafo

Segundo, revisaremos la transición cultural de nuestra especie, que primero nos permitió dejar de estar en peligro de extinción y luego nos permitió ser capaces de ocupar en pocos años todos los nichos ecológicos de la tierra.
Revisaremos la idea de que la cultura es una propiedad poblacional en la que la  estructura de la red de intercambiuos tiene un rol fundamental en los procesos de acumulación cultural, como la integración y el aislamiento afectan los procesos de evolución cultural, como fue el caso de la involución cultural sufrida por Europa occidental durante la edad media y el extraordinario desarrollo ocurrido luego de su integración privilegiada al sistema mundo gracias a la plata americana.
...
Por último, revisamos el surgimiento de la ciencia moderna en su contexto histórico, su relación con la masiva pérdida de diversidad cultural, y como consecuencia la pérdida de biodiversidad actual sin precedentes.
...
Veremos cómo los sistemas culturales capaces de superviviencia a largo plazo desarrollaron de forma independiente tecnologías de reciprocidad sociales y ecológicas bien adaptados para la coexistencia basadas en cosmovisiones paraconsistentes que les permite creer en A y no A al mismo tiempo.
...
Es decir, todos los datos están cargados de hipótesis.
...
Este nivel de acuerdo se lo conoce como \emph{base empírica epistemológica}~\cite{kilmovsky} y es lo que se utilizará como observables en la sección \nameref{sec:principios_interculturales}.

Sin embargo, la ciencia construye los ``datos'' que requieren suponer verdaderas ciertas teorías o técnicas especiales, como por ejemplo la inflación general del último mes en Argentina, o la habilidad que Maradona y Messi tenían cuando jugaron la final del mundial.
En la sección \nameref{sec:principio_evidencia} revisaremos el criterio intercultural de acuerdos intersubjetivos, que nos permite proponer una hipótesis indicadora general para incorporar la información de los observables en nuestras distribuciones de creencia.

Un dato no es teórico o no teórico sin más, sino relativamente a una teoría dada.
Por eso no se debe hablar tanto de teoricidad como de T-teoricidad, teoricidad relativa a la teoría T.
...
Para ello se requiere una evaluación que garantice los acuerdos intersubjetivos en la selección de los modelos causales alternativas.
En la sección \nameref{sec:modelos_alternativos} mostramos cómo hacer esto en un ejemplo sencillo.
En el capítulo \nameref{ch:ttt} seleccionamos modelo de estimación de habilidad de la industria del video juego, que será utilizado a lo largo de toda la tesis para estudiar los facotres de aprendizaje social.

\section{Principios interculturales de acuerdos intersubjetivos}\label{sec:principios_interculturales}

Las verdades empíricas requieren que de que alcancemos acuerdos intersubjetivos, universales, respecto de las distribuciones de creencias en contextos de incertidumbre.
Existen dos criterios de validez intercultural para alcanzar acuerdos intersubjetivos en base a la evidencia formal (modelos causales) y empírica (datos).

nuestras distribuciones de creencias deben ser capaces
...
\subsection{Principio de evidencia}
...
\section{Modelos causales alternativos}\label{sec:modelos_alternativos}
...
\section{Datos de base empírica metodológica}
...
\chapter{TrueSkill Through Time: el estimador estado del arte de la industria del video juego} \label{ch:ttt}
...
\chapter{Sistema de estimación para el juego Go (AAGo).} \label{ch:aago}
