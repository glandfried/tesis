...
\end{figure}
%
Si bien ambas respuesta son diferentes, ellas comparten la propiedad de ser la distribuci\'on de probabilidad honesta dada la evidencia formal (modelo) y emp\'irica (datos), preservando el acuerdo intersubjetivo inicial.

% Parrafo

La regla del producto y el teorema de Bayes son equivalentes.
%
En este caso tenemos que,
\begin{equation}
\begin{split}
P(r_i|s_2,c_1,M) = \frac{P(r_i, s_2|c_1,M)}{P(s_2|c_1,M)} = \frac{P(s_2|r_i,c_1,M)P(r_i|c_1,M)}{P(s_2|c_1,M)}
\end{split}
\end{equation}

En la ecuación~\ref{eq:teorema_bayes} no aparece un término
