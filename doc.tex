...
Las consecuencias de este protocolo sobre la tasa de crecimiento de los recursos es extraordinaria.
%
...
\es{Los individuos de los grupos enteramente cooperadores logran acceder a tasas de crecimiento equivalentes al promedio de estados del sistema, que en los sistemas no-ergódicos es siempre superior que la tasas de crecimiento individual. }%
%
...
¿Qué pasa si uno de los miembros decide dejar de aportar al fondo común, pero sigue recibiendo en cada ronda del fondo común?
%
...
\es{Sin embargo, lo que observamos es que el primer desertor de un grupo enteramente cooperador obtiene una tasa de crecimiento menor a la que tenía antes de desertar. }% 

% Parrafo

\en{\T }%
\es{En la figura~\ref{fig:ergodicity_desertion} podemos observar las trayectoria de los recursos de los individuos en un grupos de tamaño 100. }%
%
\begin{figure}[ht!]
    \centering
    \begin{subfigure}[b]{0.5\textwidth}
...
%
Es decir, desertar en vez de producir un aumento en la tasa de crecimiento individual, la reduce.
%
...
%
\es{Si bien los desertores siempre tienen una posición relativa mejor que los cooperadores de su propio grupo (lo que favorece al interior de los grupos la selección comportamientos desertores), en todos los casos la tasa de crecimiento más alta se obtiene por mutua cooperación (lo que favorece la selección de grupos enteramenete cooperadores sobre el resto). }%
%
...
\begin{figure}[ht!]
    ...
    \es{Tasas de crecimiento individual y cooperativa (líneas continuas y punteadas) de tres estrategias $e \in \{0.5, 0.71, 0.99\}$ (eje y) en diferentes ambiente $p$ (eje x). }%
    (b)
    ...
    \es{La tasa de crecimiento (eje y) de todas las posibles estrategias (eje x) para grupos enteramenete cooperativos de tamaño 1 a 5, en un ambiente $p=0.71$. }%
    %
    \en{The dots indicate the optimum strategy in each of the sizes. }%
    \es{Los puntos indican la estretgia óptima en cada uno de los tamaños de grupo. }%
    }
    \label{fig:tasa-temporal}
\end{figure}
%
\es{Las tasas de crecimiento individual (media geométrica) se pueden aumentar cooperativamente hasta lacanzar (la media aritmética obtenida en grupos de tamaño infinito). }%
%
En el caso especial de la estrategia $\Ee = 0.5$, ambas tasas de crecimiento son iguales.
