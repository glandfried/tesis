...
% Motivación
% Agujaro de investigación cientifico ()
% Agujero de investigaciíon tecnico (TTT, sin hablar de glicko)
% Falta lo que hice para solucionarlo
%%
% Resultados
...
%
%Esto sugiere que el contexto social, la estabilidad o volatilidad de los v\'inculos,
...
% Parrafo. Agujero de investiagación (Aprendizaje)
...
% Parrafo. Agujero de investiagación (Computin)
...
% El problema de estimación de habilidad, por ejemplo, a sido solucionado durante el siglo 20 utilizando enfoques clásicos que seleccionan una única hipótesis del espacio.
% %
...
% Parrafo. Lo que hicimos. (Antropologia)

%\todo{Agregar: Base de datos. Y aplicación para responder preguntas}
...
%que  diferencia de lo que plantea la hip\'otesis directa que supone que altas conectividades favorecen los procesos de aprendizaje, en l\'inea con estudios experimentales previos encontramos que las conectividades moderadas son las que m\'as favorecen los procesos de aprendizaje social.
