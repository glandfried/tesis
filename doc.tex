...
%
Una solución física, como por ejemplo acercarme para escuchar mejor.
%
Y una solución inferencial, interpretar la señal con ruido que recibimos.
%
Sin embargo, veremos que la solución física requiere también resolver un proceso de inferencia.
%
...
%
Los objetos que cualquier persona tomar\'ia por ciertos en su vida cotidiana constituyen una base emp\'irica significativamente más amplia, que Klimovsky~\cite{kilomosky-desventuras} llama base emp\'irica \emph{epistemol\'ogica}, pues son la base de control inicial de toda actividad cient\'ifica.
%
Sin embargo, a medida que la ciencia y la técnica avanza, algunos de los nuevos instrumentos de medición de se desarrollan (y no forman parte del sentido común) comienzan a ser aceptados como ``datos'' debido que las hip\'otesis o teor\'ias sobre los que están construidos dejan de estar en duda al interior de cierta comunidad cient\'ifica.
%
...
En cualquier caso, la base empírica depende del conjunto de supuestos que una comunidad está dispuesta a admitir sin poner en duda.
%
Los diferentes niveles de bases emp\'iricas formar\'ian una estructura en ``capas de cebolla'', con un n\'ucleo de base emp\'irica epistemol\'ogica y capas sucesivas $i$ de bases emp\'iricas metodol\'ogicas, BEM$_i$.
%
Para que uno de los niveles pueda actuar como base emp\'irica sobre la que se eval\'uan las teor\'ias cient\'ificas, es necesario que sus supuestos queden fuera de toda duda al momento de realizar la evaluación para que pueda ser considerada como ``dato de control''.
%
\begin{figure}[ht!]
    \centering
    \begin{subfigure}[b]{0.48\textwidth}
...
\end{align*}
%
Las funciones \emph{Habilidad} e \emph{Ideología} representan variables o caracter\'isticas que aplicadas sobre una unidad de an\'alisis particular, un jugador de futbol o un partido político, tienen un valor determinado, a pesar de que a veces no lo conozcamos con certidumbre.
...
%
Esto es lo que permite desarrollar usar modelos matemáticos o simulaciones computacionales, artefactos puramente formales, para representar el comportamiento de sistemas naturales.
%
Sin embargo, los dato empíricos tiene una sub-estructura operacional, que permite a través de la praxis determinar el valor concreto de los conceptos abstractos.
%
...
%
Por ejemplo, si la variable es la \emph{Habilidad$(\cdot)$}, una dimensi\'on posible a ser observada, que especifica el concepto de la variable, son los resultados de los eventos deportivos (ganar/perder), pues a partir de ellos vamos podemos inferir su valor.
%
...
%
Por último, para definir el procedimiento de medición (P) necesitamos realizar un \emph{examen de confiabilidad} donde se eval\'ua su capacidad para detectar s\'olo esa dimensi\'on de la fuente y no otros est\'imulos asociados, y de discriminar m\'inimas cantidades.
%
...
Ahora bien, ¿c\'omo hacemos para derivar el valor de la \textit{habilidad}(Messi) a partir del indicador (Ganar/Perder)?.
%
...
%
El segundo ejemplo es una mejora de este estimador, realizada a principios del siglo 21, que basado sobre el mismo modelo causal usa como hip\'otesis indicadora simplemente la aplicación estricta de las reglas de la probabilidad.
...
%
Usando las palabras de Shannon~\cite{shannon1948-theoryOfCommunication}, todo sistema de comunicación está compuesto por,
%
\begin{figure}[H]
    \centering
\tikz{
