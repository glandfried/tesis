...
\section{Hacia una ciencia de datos causal bayesiana} \label{sec:volverAlFuturo}
...
Las \'areas de investigaci\'on en aprendizaje autom\'atico (o ciencia de datos) siguen desarrollando una multitud de algoritmos gen\'ericos sin interpretaci\'on causal, que si bien permiten usar las correlaciones para predecir, no permiten sacar conclusiones causal y por lo tanto tampoco recomendaciones para la intervenci\'on en los sistemas.
%
Al mismo tiempo, quienes trabajan en ciencias sociales (u otras ciencias empíricas) proponen un enorme cantidad de argumentos causales en lenguaje natural, que si bien están fundados en el conocimiento experto del área, al no estar especificados en términos probabilísticos no pueden ser evaluados correctamente.

% Parrafo

Existe así un complementariedad mutua entre el \'area del aprendizaje autom\'atico y las ciencias sociales que todavía no está siendo explotada.
%
...
\subsection{Objetivo: especificar y evaluar argumentos casuales.}

El objetivo de este plan es implementar y desarrollar metodologías de trabajo que permitan poner en valor el conocimiento experto mediante la especificación y evaluación probabilística de argumentos casuales expresados en lenguaje natural.
%
Esta metodología sería tanto para las ciencias sociales, donde las teorías se expresan todavía en lenguaje natural, como para el \'area de aprendizaje automático, que al trabajar sin modelos causales se ve impedida de sacar conclusiones causales.
%
El desafío de este plan consiste traducir matemáticamente argumentos expresados en lenguaje natural, integrar los diferentes elementos de prueba en un único modelo probabilístico causal, computar correctamente el valor de verdad de los modelos causales alternativos.
%
...
\subsection{Herramienta: métodos gráficos e inferencia causal probabilística.}
