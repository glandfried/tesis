...
Este modelo establece que un equipo vence a otro cuando el rendimiento de su equipo es mayor que el rendimiento del equipo contrario.
%
Con $A$ la partición de jugadores (la asignación de equipos),
