...
La propiedad mayor nos ofrece un argumento para explicar la emergencia permanente de las transiciones evolutivas mayores en la historia de la vida, en las que entidades individuales formar unidades cooperativas superiores a través del intercambio de recursos, pero también permite explicar la emergencia de transiciones epistémicas mayores en la historia del conocimiento, en las que hipótesis individuales se agregan para formar hipótesis de nivel superior a través del intercambio de conocimientos.
%
La propiedad menor, que solo es relevante en el corto plazo, nos ofrece por su parte un argumento para explicar la ventaja circunstancial que las variantes desertoras logran obtener recurrentemente.
...
En la historia del ser humano, la cooperación epistémica mediante la transmisión de conocimiento entre individuos, tuvo un efecto positivo radical para nuestra especie.
...
% %
En algunas como las ballenas, delfines, primates y aves las tradiciones llegan a ser bastante complejas, llegando a desarrollar un conjunto amplio de conocimientos específicos se adquieren primero por experiencia individual y luego son imitados al resto~\cite{aplin2022-birdsCulture}.
%
Sin embargo, todas ellas son manifiestamente más simples que la cultura humanas.
...
%
Y a la inversa, para que evolucionen estas características innatas es necesario la presencia previa de alguna lenguas primitiva que proporcionara una entorno cultural que presionara a favor de la selección de mejores habilidades lingüísticas innatas.
%
...
En las culturas humanas, la acumulación de innovaciones pone a disposición  tecnologías que nadie podría redescubrir individualmente en un período de vida, incluso en las sociedades cazadoras recolectoras aparentemente simples.
%
En este proceso, la reciprocidad ecológica por interacción simbiótica prolongada con plantas y animales, produjo la aparición independiente de la agricultura en África subsahariana, Oriente medio, China, Oceanía, América del Norte y América del Sur (puntos rojos de la figura~\ref{fig:poblamiento}).
%
Y el aumento de la población que se produjo con ella, intensificó aun más los procesos de evolución cultural acumulativa, haciendo de estas regiones los principales centros tecnológicos de la humanidad.
...
%
En el mundo Árabe se comerciaba productos desde el océano Atlántico en España, hasta el océano Pacífico en las Filipinas.
%
El océano Pacífico estaba totalmente ocupado, y ya se habían producido intercambios entre Oceanía y América del Sur, que se refleja en la genética de las poblaciones actuales (figura~\ref{fig:pacifico}).
%
...
%
El ejemplo más paradigm\'atico es el aislamiento total que ocurre con la separaci\'on de Tasmania del continente Australiano por la subida del nivel del mar ocurrida a comienzos del Holonceno.
%
...
De forma similar, la masiva destrucción de la diversidad cultural producida previamente por el imperio Romano en su entorno, había producido el aislamiento parcial de Europa occidental del sistema mundo, conduciéndola a contramano del resto del mundo a un largo proceso de involución cultural y de violencia interna conocido como ``Edad media''.
%
La ruptura del pacto cooperativo tuvo consecuencias negativas concretas para esta sociedad.
%
...
%
Un sistema penal desenfrenado renació de los llamados \emph{libris terribilis} y las instituciones heredadas del imperio romano de occidente comenzaron a regular las relaciones comunitaria de reproducción sexual de forma más detallada que con la propiedad privada.
%
Y la guerra contra las mujeres se formaliza definitivamente con la publicación del \emph{Malleus maleficarum} en 1484 (caza de brujas), que será el segundo best seller después de la Biblia durante los siguientes 200 años.
...
%
Las enfermedades transmitidas por los exploradores feudales eliminó, al menos, 2/3 de la población americana.
%
No se produce ningún giro geopolítico hasta que los exploradores descubren la montaña de plata de Potosí en 1546, metal que China había incorporado recientemente como una de sus monedas oficiales.
%
...
%Sólo después de que la sociedad feudal adquiere una posición de privilegio en el sistema mundo, comienza al interior de esta sociedad, un nuevo debate sobre las fuentes de validación del conocimiento.
%
%En esta época, el criterio de experiencia personal como fundamento del saber auténtico comenzó a reemplazar los criterios de autoridad de la Edad Media.
% %
...
% %
%Sin embargo, estos nuevos criterios, que permitían democratizar el conocimiento al interior de la sociedad feudal, estaban reservados para uso exclusivo de sus miembros varones.
%
%
El argumento de superioridad moral, que desarrolla Ginés de Sepúlveda cuatro años después del descubrimiento de la plata de Potosí, será utilizado durante toda la modernidad hasta el presente.
\begin{quotation}
...
\end{quotation}
%
%El sujeto masculino blanco se torna modelo del interés general y valor universal, y el resto de los seres vivos se transforma en meros recursos instrumentales.
%
Esta idea continúa vigente incluso cuando se propone que la validez universal del conocimiento radicaría en el reconocimiento mutuo.
%
\begin{quotation}
...
% %
No hay contradicción porque el concepto feudal-colonial-moderno de ``universalidad'' nace limitado.
% %
