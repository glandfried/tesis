...
\end{quotation}
%
En este sentido la distribución de probabilidad honesta se obtiene la que no afirma más de lo que sabés (maximiza la incertidumbre) sin dejar de decir todo lo que sí se sabe (dada la información disponible).
%
...
%
Podemos sospechar, por ejemplo, que existe una dependencia adicional entre la caja que elegimos
y la pista que nos dan, si elegimos la caja $i$, $C=c_i$, no puede ocurrir que se muestre el interior de la caja $S=s_i$.
%
A
