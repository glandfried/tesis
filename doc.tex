...
Expresar subjetividades individuales no tiene ningún valor para la ciencia.
%
La ciencia es una instituci\'on que tiene pretensi\'on de alcanzar verdad, proposiciones que sean valgan de forma universal.
%
Las ciencias formales (matem\'atica, l\'ogica) validan esas proposiciones derivando teoremas dentro de sistemas axiom\'aticos cerrados.
%
...
%
%¿Cómo se pueden validar de forma universal proposiciones en ciencias que tienen siempre algún grado de incertidumbre?
%
...
%
Llamamos a esto, acuerdos intersubjetivos en contextos de incertidumbre.

% Parrafo

?`Es posible entonces alcanzar acuerdos intersubjetivos (``verdades'') en las ciencias emp\'iricas si es inevitable decir ``no s\'e''?
%
La historia del enfoque bayesiano de la probabilidad encontró una respuesta.
%
En pocas palabras, para ser honestos debemos evitar decir m\'as de lo que se sabe, incorporando al mismo tiempo toda la informaci\'on disponible.
