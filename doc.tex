...
La sociedades humanas pueden ser vistas como sistemas naturales de procesamiento distribuido de información, y la cultura un fen\'omeno poblacional que emerge como consecuencia del intercambio entre sus individuos.
Entender cómo cambia la cultura en el tiempo es uno de los problemas que las ciencias de la computación deberán responder en los próximos años.
Hasta ahora, ha sido principalmente mediante modelos matemáticos simples como se ha logrado introducir respuestas que han tenido una gran influencia en la antropologı́a actual.
...
Si bien los modelos matemáticos sirven para ganar intuición de las consecuecias que ciertas relaciones causales podrı́an tener en los fenómenos naturales, en caso de que sus estructuras sean análoga, sus resultados no están destinados a realizar predicciones, y por lo tanto poseen poca o nula corroboración empı́rica.
