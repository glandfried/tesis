...
mtext(text=expression("Performance"~p[j]) ,side =2 ,line=1.75,cex=1.75)
mtext(text=expression("Performance"~p[i]) ,side =1 ,line=2.5,cex=1.75)
abline(v=1750,lty=3)
abline(h=1500,lty=3)
#lines(c(0,1)*(s_2+s_2-500),c(1,0)*(s_2+s_2-500))
lines(c(0,1)*(s_2+s_2-500),c(0,1)*(s_2+s_2-500),col=rgb(0,0,0,0.75))
text(s_2-250,s_1+250,"Win j",cex=1.33)
text(s_1+250,s_2-250,"Win i",cex=1.33)
...
axis(lwd=0,side=1, at=s_1,labels=expression(s[i]),las=0,cex.axis=1.33,line=-0.3)
axis(lwd=0,side=2, at=s_2,labels=expression(s[j]),las=0,cex.axis=1.33,line=-0.3)
