...
mtext("Performance", side=2, line=2,cex = 1.75)
mtext("Skill", side=1, line=2,cex = 1.75)
...
points(mu,mu,pch=19)
lines(mu+(p_grilla-mu)*(4/5) ,s_grilla,cex=0.1,lty=2)
abline(h=p,lty=1,col=rgb(0,0,0,1))
