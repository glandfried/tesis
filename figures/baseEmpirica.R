...
plot(0,0,type="l",ylim=c(-5,5),xlim=c(-2,8) ,ylab = "",xlab="",axes=F)
draw.elipse(a=0.8,b=0.6,x0=0,fill=T,lwd=2)
draw.elipse(a=2,b=1,x0=1, fill=T, col=rgb(0,0,0,0.2), lwd=2)
draw.elipse(a=3.5,b=1.5,x0=2, lwd=2)
text(1.8,0.0,"Habilidad",cex=1.25)
text(4.15,0.0,"Factores de\naprendizaje",cex=1.25)
text(0,0,"Resultado",cex=1.25,col=rgb(1,1,1))
